...
| Icon                  | Description |
| --------------------- | ----------- |
| ![](/img/visionary-render-programming/script-editor-script-icon.png) | A script with no unsaved changes or compile errors. |
| ![](/img/visionary-render-programming/script-editor-save-icon.png) | A script with unsaved changes. |
| ![](/img/visionary-render-programming/script-editor-broken-icon.png) | A script with compile errors. |
