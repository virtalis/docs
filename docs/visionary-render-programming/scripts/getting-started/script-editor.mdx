...
![](/img/visionary-render-programming/script-editor.webp)
...
| Icon                  | Description |
| --------------------- | ----------- |
| ![](/img/visionary-render-programming/script-editor-script-icon.webp) | A script with no unsaved changes or compile errors. |
| ![](/img/visionary-render-programming/script-editor-save-icon.webp) | A script with unsaved changes. |
| ![](/img/visionary-render-programming/script-editor-broken-icon.webp) | A script with compile errors. |
...
![](/img/visionary-render-programming/script-editor-find.webp)

Click on the **Find and Replace** button in the titlebar to show or hide the Find and Replace bar. It can also be shown from the Script Editor with `Ctrl` + `F`.
