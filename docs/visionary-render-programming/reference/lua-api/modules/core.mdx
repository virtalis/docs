...
| boolean | **[vrBakeMesh](#vrbakemesh)**([vrnode](../classes/vrnode.mdx) targetNode)<br />Converts deformable meshes to static meshes for export and upload. |
...
| boolean | **[vrCanCompressTexture](#vrcancompresstexture)**([vrnode](../classes/vrnode.mdx) node)<br />Determines whether DXT compression can be applied to a texture.  |
| boolean | **[vrCanScaleTexture](#vrcanscaletexture)**([vrnode](../classes/vrnode.mdx) node)<br />Determines whether a texture can be scaled.  |
...
| void | **[vrCompressTexture](#vrcompresstexture)**([vrnode](../classes/vrnode.mdx) node)<br />Applies DXT compression to a texture.  |
...
| void | **[vrControlManikinJoints](#vrcontrolmanikinjoints)**([vrnode](../classes/vrnode.mdx) manikin, boolean controlRemotely, [vrnode](../classes/vrnode.mdx) user)<br />Take control of a manikin's joints with a specified user (or local user if none specified).  |
| void | **[vrControlManikinTargets](#vrcontrolmanikintargets)**([vrnode](../classes/vrnode.mdx) manikin, boolean controlRemotely, [vrnode](../classes/vrnode.mdx) user)<br />Take control of a manikin with a specified user (or local user if none specified).  |
...
| table | **[vrGetDirectoryContents](#vrgetdirectorycontents)**(string path, string filter, boolean includeFolders, boolean includeFiles)<br />Gets the contents of a directory. |
...
| [vrnode](../classes/vrnode.mdx) | **[vrGroupSnapshot](#vrgroupsnapshot)**([vrnode](../classes/vrnode.mdx) groupNode, [vrnode](../classes/vrnode.mdx) snapNode)<br />Creates a snapshot of the specified group.  |
...
| [vrnode](../classes/vrnode.mdx) | **[vrMakeBox](#vrmakebox)**([vrnode](../classes/vrnode.mdx) parent, string name, number width, number height, number depth, number stacks, number slices, boolean reverseWinding)<br />Creates a box shape.  |
| [vrnode](../classes/vrnode.mdx) | **[vrMakeCylinder](#vrmakecylinder)**([vrnode](../classes/vrnode.mdx) parent, string name, number bottomRadius, number topRadius, number height, number stacks, number slices, boolean reverseWinding)<br />Creates a cylinder shape.  |
| [vrnode](../classes/vrnode.mdx) | **[vrMakeEllipsoid](#vrmakeellipsoid)**([vrnode](../classes/vrnode.mdx) parent, string name, number radiusX, number radiusY, number radiusZ, number stacks, number slices, boolean reverseWinding)<br />Creates an ellipsoid shape.  |
| [vrnode](../classes/vrnode.mdx) | **[vrMakePlane](#vrmakeplane)**([vrnode](../classes/vrnode.mdx) parent, string name, number hsize, number vsize, number stacks, number slices, boolean reverseWinding, boolean doubleSided)<br />Creates a plane shape.  |
...
| void | **[vrNetworkSetRetryConnect](#vrnetworksetretryconnect)**(boolean allowRetry)<br />Sets whether failed calls to vrLinkNetwork should retry until the user manually aborts them.  |
...
| void | **[vrReleaseManikin](#vrreleasemanikin)**([vrnode](../classes/vrnode.mdx) manikinOrUser)<br />Releases a manikin from the user who is controlling it.  |
...
| void | **[vrScaleTexture](#vrscaletexture)**([vrnode](../classes/vrnode.mdx) node, number scaleX, number scaleY =0.0)<br />Scales a texture by the specified factor.  |
...
| void | **[vrTrackedCursorGetTouchedAssembly](#vrtrackedcursorgettouchedassembly)**(number index)<br />Gets the first assembly currently under the tracked cursor.  |
| void | **[vrUnloadPlugin](#vrunloadplugin)**(string pluginInfo)<br />Unloads the specified plugin. |
...
Converts deformable meshes to static meshes for export and upload.

**Parameters**: 

  * **targetNode** The node of the visual you want to convert
...
### vrCanCompressTexture

```lua
boolean vrCanCompressTexture(
    vrnode node
)
```

Determines whether DXT compression can be applied to a texture.

**Parameters**: 

  * **node** vrnode The texture to compress

**Return**: true if the texture can be compressed

### vrCanScaleTexture

```lua
boolean vrCanScaleTexture(
    vrnode node
)
```

Determines whether a texture can be scaled.

**Parameters**: 

  * **node** vrnode The texture to scale

**Return**: true if the texture can be scaled
...
```lua
void vrCompressTexture(
    vrnode node
)
```

Applies DXT compression to a texture.
...
### vrControlManikinJoints

```lua
void vrControlManikinJoints(
    vrnode manikin,
    boolean controlRemotely,
    vrnode user
)
```

Take control of a manikin's joints with a specified user (or local user if none specified).

**Parameters**: 

  * **manikin** The manikin whose joints to take control of
  * **controlRemotely** Whether to control the manikin remotely by not locking the camera to its position
  * **user** The user who will take control of the manikin (local user if none specified)

### vrControlManikinTargets

```lua
void vrControlManikinTargets(
    vrnode manikin,
    boolean controlRemotely,
    vrnode user
)
...
Take control of a manikin with a specified user (or local user if none specified).

**Parameters**: 

  * **manikin** The manikin to take control of
  * **controlRemotely** Whether to control the manikin remotely by not locking the camera to its position
  * **user** The user who will take control of the manikin (local user if none specified)
...
### vrGetDirectoryContents

```lua
table vrGetDirectoryContents(
    string path,
    string filter,
...
**Parameters**: 
  ...
  * **filter** A list of filters separated by '|', e.g. '\*.jpg|\*.png' *[default: nil]*
  * **includeFolders** Should folders be included in the results *[default: false]*
  * **includeFiles** Should files be included in the results *[default: true]*

**Return**: A table of tables where each subtable contains details of one file/folder in the specified directory: 'name', 'path', 'size' and 'isFolder'
...
**Parameters**: 
  ...
  * **groupNode** The group node 
  * **snapNode** The existing snapshot node that will be replaced if specified *[default: nil]*
...
```lua
void vrReleaseManikin(
    vrnode manikinOrUser
)
```

Releases a manikin from the user who is controlling it.

**Parameters**: 

  * **manikinOrUser** The manikin to release or the user who is controlling the manikin
...
Scales a texture by the specified factor.
...
**Parameters**: 
  ...
  * **index** The index of the hand to check, 0 = left hand, 1 = right hand [default: 1]
