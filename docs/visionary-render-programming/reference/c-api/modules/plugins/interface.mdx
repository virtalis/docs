...
| Type           | Name           |
| -------------- | -------------- |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPCleanupProc](#typedef-vrpcleanupproc)** <br />Function prototype for the plugin cleanup function.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPDefaultRecipeProc](#typedef-vrpdefaultrecipeproc)** <br />Function prototype for getting the name of the default recipe file used by the importer.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPDependsProc](#typedef-vrpdependsproc)** <br />Function prototype for getting the plugin dependencies.  |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(const char *outFile, HNode fromRoot, HNode fromScenes, HNode fromLibs, const char *recipePath) | **[VRPExportProc](#typedef-vrpexportproc)** <br />Function prototype for an export function.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPFFINamespaceProc](#typedef-vrpffinamespaceproc)** <br />Function prototype for getting the FFI namespace/module name to use for this plugin.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPFormatsProc](#typedef-vrpformatsproc)** <br />Function prototype for getting the XML description of formats accepted by [VRPImportProc.  |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPGetAPIVersionProc](#typedef-vrpgetapiversionproc)** <br />Function prototype for the API version functions.  |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(const char *permissions) | **[VRPHasPermissionProc](#typedef-vrphaspermissionproc)** <br />Function prototype for checking permission to do something. Plugin will be passed a check function if it exports [VRPRegisterHasPermissionProc.  |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(const char *file, HNode root, HNode scenes, HNode libs, uint64_t flags, const char *recipePath) | **[VRPImportProc](#typedef-vrpimportproc)** <br />Function prototype for an import function.  |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPInitProc](#typedef-vrpinitproc)** <br />Function prototype for the plugin init function.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPLockedProc](#typedef-vrplockedproc)** <br />Function prototype for getting the plugin lock condition.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(char indent) | **[VRPLogIndentProc](#typedef-vrplogindentproc)** <br />Function prototype for the log indent function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(int type, const char *message) | **[VRPLogProc](#typedef-vrplogproc)** <br />Function prototype for the log function.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPNameProc](#typedef-vrpnameproc)** <br />Function prototype for getting the plugin full name.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(int currentValue, int maxValue, const char *message) | **[VRPProgressYieldProc](#typedef-vrpprogressyieldproc)** <br />Function prototypes for a progress yield function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPHasPermissionProc) | **[VRPRegisterHasPermissionProc](#typedef-vrpregisterhaspermissionproc)** <br />Function prototype for registering a permission check function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPLogIndentProc) | **[VRPRegisterLogIndentProc](#typedef-vrpregisterlogindentproc)** <br />Function prototype for being given a log indent function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPLogProc) | **[VRPRegisterLogProc](#typedef-vrpregisterlogproc)** <br />Function prototype for being given a log function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPProgressYieldProc) | **[VRPRegisterProgressYieldProc](#typedef-vrpregisterprogressyieldproc)** <br />Function prototype for registering a progress yield function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPRequestPermissionProc) | **[VRPRegisterRequestPermissionProc](#typedef-vrpregisterrequestpermissionproc)** <br />Function prototype for registering a permission request function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPUserMessageProc) | **[VRPRegisterUserMessageProc](#typedef-vrpregisterusermessageproc)** <br />Function prototype for registering a message function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPUserQuestionCallbackRegisterProc) | **[VRPRegisterUserQuestionCallbackProc](#typedef-vrpregisteruserquestioncallbackproc)** <br />Function prototype for registering a question callback function.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPUserQuestionProc) | **[VRPRegisterUserQuestionProc](#typedef-vrpregisteruserquestionproc)** <br />Function prototype for registering a question function.  |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(const char *permissions, const char *cancelCaption) | **[VRPRequestPermissionProc](#typedef-vrprequestpermissionproc)** <br />Function prototype for requesting permission to do something.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPSettingsInterfaceProc](#typedef-vrpsettingsinterfaceproc)** <br />Function prototype for getting the XML description of the settings that should be presented in a user interface.  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPShortNameProc](#typedef-vrpshortnameproc)** <br />Function prototype for getting the plugin short name (-import shortcut)  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPSignatureProc](#typedef-vrpsignatureproc)** <br />Function prototype for getting the plugin signature (license)  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(const char *message) | **[VRPUserMessageProc](#typedef-vrpusermessageproc)** <br />Function prototype for triggering an application dialog containing a message to present directly to the user.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(int result, void *userData) | **[VRPUserQuestionCallbackProc](#typedef-vrpuserquestioncallbackproc)** <br />Function prototype for a callback to call when a user chooses an option presented by a UserQuestion.  |
| typedef void([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(VRPUserQuestionCallbackProc proc, void *userData) | **[VRPUserQuestionCallbackRegisterProc](#typedef-vrpuserquestioncallbackregisterproc)** <br />Function prototype for registering a [VRPUserQuestionCallbackProc](#typedef-vrpuserquestioncallbackproc) as the callback for UserQuestion dialogs.  |
| typedef int([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(const char *message) | **[VRPUserQuestionProc](#typedef-vrpuserquestionproc)** <br />Function prototype for triggering an application dialog containing a question to ask to the user. This also requires a registered [VRPUserQuestionCallbackProc](#typedef-vrpuserquestioncallbackproc).  |
| typedef const char *([VRTREE_APIENTRY](../plugins/index.mdx#define-vrtree-apientry) *)(void) | **[VRPVersionProc](#typedef-vrpversionproc)** <br />Function prototype for getting the plugin version (human readable, not API version)  |

## Attributes

| Type           | Name           |
| -------------- | -------------- |
| const int | **[PLUGIN_API_VERSION_MAJOR](#plugin_api_version_major)** <br />incremented if backward compatibility is broken  |
| const int | **[PLUGIN_API_VERSION_MINOR](#plugin_api_version_minor)** <br />incremented if new exports are added  |
...
**Return**: Value of [PLUGIN_API_VERSION_MAJOR](#plugin_api_version_major) for `VRPGetAPIVersionMajor`, Value of [PLUGIN_API_VERSION_MINOR](#plugin_api_version_minor) for `VRPGetAPIVersionMinor`

**Note**: `vrtree-linker` provides [VRPLUGIN_API_STDIMPL](../plugins/utilities.mdx#define-vrplugin-api-stdimpl) to implement these automatically 
...
Some log messages need to have more complex formatting, so plugins can use this function to indent all further log messages. Plugin will be passed a log indent function to use for logging, if it exports [VRPRegisterLogIndentProc](#typedef-vrpregisterlogindentproc). 
...
Plugin will be passed a log function to use for logging, if it exports [VRPRegisterLogProc](#typedef-vrpregisterlogproc). 
...
Plugin will be passed a yield function to call during long operations, if it exports the [VRPRegisterProgressYieldProc](#typedef-vrpregisterprogressyieldproc) function. 
...
**Note**: `vrtree-linker` provides [VRPLUGIN_API_PERMISSIONIMPL](../plugins/utilities.mdx#define-vrplugin-api-permissionimpl) to provide [VRPLUGIN_INIT_PERMISSION](../plugins/utilities.mdx#define-vrplugin-init-permission) and [VRPLUGIN_IMPORT_PERMISSION](../plugins/utilities.mdx#define-vrplugin-import-permission)
...
**Note**: `vrtree-linker` provides [VRPLUGIN_API_LOGIMPL](../plugins/utilities.mdx#define-vrplugin-api-logimpl) to provide `s_logFunc` and `s_logIndentFunc`
...
**Note**: `vrtree-linker` provides [VRPLUGIN_API_YIELDIMPL](../plugins/utilities.mdx#define-vrplugin-api-yieldimpl) to provide progress_yield 
...
Plugin should implement this and use the pointer it is given to register a callback to be called by question boxes summoned by a [VRPUserQuestionProc](#typedef-vrpuserquestionproc)

This is not useful without also implementing [VRPRegisterUserQuestionCallbackProc](#typedef-vrpregisteruserquestioncallbackproc)
...
Plugin will be passed a request function if it exports [VRPRegisterRequestPermissionProc](#typedef-vrpregisterrequestpermissionproc)
...
Plugin will be passed a message function to use if it exports [VRPRegisterUserMessageProc](#typedef-vrpregisterusermessageproc)
...
Function prototype for registering a [VRPUserQuestionCallbackProc](#typedef-vrpuserquestioncallbackproc) as the callback for UserQuestion dialogs. 

Plugin will be passed a register function if it exports [VRPRegisterUserQuestionCallbackProc](#typedef-vrpregisteruserquestioncallbackproc)
...
Function prototype for triggering an application dialog containing a question to ask to the user. This also requires a registered [VRPUserQuestionCallbackProc](#typedef-vrpuserquestioncallbackproc). 
...
Plugin will be passed a question function to use if it exports [VRPRegisterUserQuestionProc](#typedef-vrpregisteruserquestionproc)
