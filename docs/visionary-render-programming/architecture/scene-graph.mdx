...
![](/img/visionary-render-programming/material-texture-ref.webp)
...
![](/img/visionary-render-programming/model-structure.webp)
...
![](/img/visionary-render-programming/visual-model-ref.webp)
