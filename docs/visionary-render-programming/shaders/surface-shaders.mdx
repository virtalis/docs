...
![](/img/visionary-render-programming/surface-shader-click-drag-apply.webp)
...
![](/img/visionary-render-programming/surface-shader-instance-applied.webp)

### Right-Click on a Material and select "Create -> Surface Shader Instance". 

![](/img/visionary-render-programming/surface-shader-create.webp)
...
![](/img/visionary-render-programming/surface-shader-param-inherit.webp)
...
![](/img/visionary-render-programming/surface-shader-param-types.webp)
