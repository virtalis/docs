...
![](/img/visionary-render-programming/vs-new-dll.webp)

Open the Configuration Manager
![](/img/visionary-render-programming/vs-config-mgr.webp)

Edit the Active Solution Platforms
![](/img/visionary-render-programming/vs-edit-platform.webp)

Remove the x86 platform
![](/img/visionary-render-programming/vs-del-x86.webp)

Open the project properties
![](/img/visionary-render-programming/vs-project-props.webp)
...
![](/img/visionary-render-programming/vs-cpp-incdir.webp)
...
![](/img/visionary-render-programming/vs-link-dir.webp)
...
![](/img/visionary-render-programming/vs-link-deps.webp)

Add a cpp file (e.g. main.cpp)
![](/img/visionary-render-programming/vs-add-main.webp)
...
![](/img/visionary-render-programming/plugin-settings.webp)

The table displays all loaded plugins and the "My Plugin" plugin should be visible here.

![](/img/visionary-render-programming/sample-plugin.webp)
...
![](/img/visionary-render-programming/hello-diagnostics.webp)
