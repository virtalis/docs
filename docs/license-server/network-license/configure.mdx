...
1. Open the Start Menu and follow the link **Virtalis License Server - Admin Panel** to open the admin panel in your default browser.
   ...
   ![](/img/license-server/start-menu.webp)
...
3. Once you have logged in, you should see the below page. From here, you can view a list of available licenses, import new ones, connect to a license server, or configure the license settings for this application.
   ...
   ![](/img/license-server/overview.webp)
...
![](/img/license-server/import-licenses.webp)
...
![](/img/license-server/task-manager.webp)
