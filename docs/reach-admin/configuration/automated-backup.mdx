...
Virtalis Reach comes with an automated back up system that allows you to restore to an earlier snapshot in the event of a disaster. We will install [Velero](https://velero.io/docs/v1.5/index.html) to back up the state of your Kubernetes Cluster and uses a custom built solution which leverages [Restic](https://restic.readthedocs.io/en/stable/) to back up the persistent data imported into Virtalis Reach.
...
test-backup-1   Completed   0        0          2022-0...   29d       reach-velero       <none>
test-backup-2   Completed   0        0          2022-0...   29d       reach-velero       <none>
```
