...
![](/img/visren/windows/browser/overview.png)
...
| View | Description |
| --- | --- |
| ![](/img/visren/windows/browser/large.png) | ![](/img/visren/windows/browser/large-icon.png) **Large icons**<br/>Show 96 x 96 px previews and icons of assets followed by their names. |
| ![](/img/visren/windows/browser/small.png) | ![](/img/visren/windows/browser/small-icon.png) **Small icons**<br/>Show 48 x 48 px previews and icons of assets followed by their names. |
| ![](/img/visren/windows/browser/list.png) | ![](/img/visren/windows/browser/list-icon.png) **List**<br/>Show 16 x 16 px previews and icons of assets followed by their name and properties. Most of the properties can be edited. |
...
![](/img/visren/windows/browser/group.png)
...
![](/img/visren/windows/browser/create-asset.png)
