...
![](/img/visren/windows/animation-sequencer/overview.png)
...
| Button                                 | Description |
|----------------------------------------|-------------|
| ![](/img/visren/windows/animation-sequencer/start.png)  | Seek to start of sequence (`Home`). |
| ![](/img/visren/windows/animation-sequencer/end.png)  | Seek to end of sequence (`End`). |
| ![](/img/visren/windows/animation-sequencer/prev-frame.png)  | Seek to previous frame (`Up` or `Left Arrow`). |
| ![](/img/visren/windows/animation-sequencer/next-frame.png)  | Seek to next frame (`Down` or `Right Arrow`). |
| ![](/img/visren/windows/animation-sequencer/play-backward.png)   | Play sequence backwards from current time. |
| ![](/img/visren/windows/animation-sequencer/play-forward.png)  | Play sequence forwards from current time. |
| ![](/img/visren/windows/animation-sequencer/pause.png)  | Pause sequence at current time. This is shown over the play button whilst a sequence is playing. |
| ![](/img/visren/windows/animation-sequencer/loop.png)  | Enable or disable looped playback. |
| ![](/img/visren/windows/animation-sequencer/record.png) | In Manual capture mode, record the current state of the track targets. In Continuous or Motion capture mode, start or stop recording. The button is highlighted red whilst recording is in progress. |

### Properties Panel

![](/img/visren/windows/animation-sequencer/properties-panel.png)
...
![](/img/visren/windows/animation-sequencer/track-list.png)
...
![](/img/visren/windows/animation-sequencer/resize.png)

### Timeline

![](/img/visren/windows/animation-sequencer/timeline.png)
...
| ![](/img/visren/windows/animation-sequencer/time-grip.png) | The Time Grip marks the current sequence position. Drag it along the timeline to animate the sequence. Double-click on it to return to time zero. |
| --- | --- |

### Track View

![](/img/visren/windows/animation-sequencer/track-view.png)
...
|----------------------------------------|---------------|----------------------------------------|----------------|
| ![](/img/visren/windows/animation-sequencer/keyframe.png) | Keyframe      | ![](/img/visren/windows/animation-sequencer/animation.png) | Animation      |
| ![](/img/visren/windows/animation-sequencer/custom-action.png) | Custom Action | ![](/img/visren/windows/animation-sequencer/property-track.png) | Property Track |
| ![](/img/visren/windows/animation-sequencer/audio.png) | Audio         | ![](/img/visren/windows/animation-sequencer/sequence-track.png) | Sequence Track |
...
- Press the ­­­­![](/img/visren/windows/animation-sequencer/create.png) button in the Sequencer’s titlebar to add a sequence to a selected node. If no suitable nodes are selected, the sequence will be added to the Scenes node.
...
![](/img/visren/windows/animation-sequencer/track.png)
...
![](/img/visren/windows/animation-sequencer/interpolation.png)
...
![](/img/visren/windows/animation-sequencer/orient-to.png)
...
![](/img/visren/windows/animation-sequencer/reverse.png)
...
![](/img/visren/windows/animation-sequencer/scene-visuals.png)
...
![](/img/visren/windows/animation-sequencer/markers.png)
...
![](/img/visren/windows/animation-sequencer/browser1.png)

List view provides controls and information about number of animations, speed, etc.

![](/img/visren/windows/animation-sequencer/browser2.png)

## Settings

The Sequencer can be configured via **Settings** > **Animation Sequencer**.

![](/img/visren/windows/animation-sequencer/settings.png)
