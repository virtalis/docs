...
![](/img/visren/windows/properties/overview.png)
...
The ![](/img/visren/windows/properties/prev.png) and ![](/img/visren/windows/properties/next.png) buttons navigate backwards and forwards through the selection history. Click on the drop-down arrow to the right of them to open a list of recently selected nodes.

![](/img/visren/windows/properties/history.png)

## Subtree Stats

Click on the ![](/img/visren/windows/properties/info.png) icon to show or hide subtree statistics for the current selection. This generates a table with a total ancestor node count and counts for each type of node.

![](/img/visren/windows/properties/subtree-stats.png)
...
![](/img/visren/windows/properties/multiselect1.png)
...
![](/img/visren/windows/properties/multiselect2.png)
...
![](/img/visren/windows/properties/reset-all.png)
