...
| Type           | Name           |
| -------------- | -------------- |
| const int | **[PLUGIN_API_VERSION_MAJOR](#plugin-api-version-major)** <br />incremented if backward compatibility is broken  |
| const int | **[PLUGIN_API_VERSION_MINOR](#plugin-api-version-minor)** <br />incremented if new exports are added  |
...
**Return**: Value of [PLUGIN_API_VERSION_MAJOR](#plugin-api-version-major) for `VRPGetAPIVersionMajor`, Value of [PLUGIN_API_VERSION_MINOR](#plugin-api-version-minor) for `VRPGetAPIVersionMinor`
