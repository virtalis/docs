...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[Format](#enum-format)** \{ Format_RGBA8, Format_RGBA8_ToneMap, Format_RGBA16, Format_RGBA32, Format_Luminance8, Format_Luminance8_ToneMap, Format_Luminance16, Format_Luminance32 \}<br />Values for Idx_TextureFormat.  |
| enum| **[IDX](#enum-idx)** \{ Idx_Enabled, Idx_TextureSize, Idx_TextureFormat, Idx_Stereo, Idx_MipmapEnabled \}<br />Property index.  |
...
| Idx_TextureFormat | | [Format](../metanodes/meta-render-to-texture.mdx#enum-format) (int) - The texture format to generate   |
