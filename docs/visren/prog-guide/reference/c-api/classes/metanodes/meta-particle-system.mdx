...
A ParticleSystem emits particles. It gets its transform from a parent [Meta_Assembly](../metanodes/meta-assembly.mdx). 
...
| Idx_BlendMode | | [BlendMode](#enum-blendmode) (int) - Specifies the particle renderer blend mode   |
...
| Idx_BillboardMode | | [BillboardMode](#enum-billboardmode) (int) - Specify how the particles should be aligned   |
| Idx_OrientU | | bool -   |
| Idx_OrientV | | bool -   |
| Idx_FlipU | | bool -   |
| Idx_FlipV | | bool -   |
...
| Idx_EmitShape | | [EmitShape](#enum-emitshape) (int) - Controls the initial position and direction of an emitted particle.   |
