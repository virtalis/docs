...
![](/img/visren/prog-guide/vs-new-dll.png)

Open the Configuration Manager
![](/img/visren/prog-guide/vs-config-mgr.png)

Edit the Active Solution Platforms
![](/img/visren/prog-guide/vs-edit-platform.png)

Remove the x86 platform
![](/img/visren/prog-guide/vs-del-x86.png)

Open the project properties
![](/img/visren/prog-guide/vs-project-props.png)
...
![](/img/visren/prog-guide/vs-cpp-incdir.png)
...
![](/img/visren/prog-guide/vs-link-dir.png)
...
![](/img/visren/prog-guide/vs-link-deps.png)

Add a cpp file (e.g. main.cpp)
![](/img/visren/prog-guide/vs-add-main.png)
...
![](/img/visren/prog-guide/hello-diagnostics.png)
