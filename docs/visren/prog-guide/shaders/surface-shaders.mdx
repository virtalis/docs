...
![](/img/programming-guide/surface-shader-click-drag-apply.png)
...
![](/img/programming-guide/surface-shader-instance-applied.png)

#### 2. Right-Click on a Material and select "Create -> Surface Shader Instance". 

![](/img/programming-guide/surface-shader-create.png)
...
![](/img/programming-guide/surface-shader-param-inherit.png)
...
![](/img/programming-guide/surface-shader-param-types.png)
