...
![](/img/visren/prog-guide/surface-shader-click-drag-apply.png)
...
![](/img/visren/prog-guide/surface-shader-instance-applied.png)

#### 2. Right-Click on a Material and select "Create -> Surface Shader Instance". 

![](/img/visren/prog-guide/surface-shader-create.png)
...
![](/img/visren/prog-guide/surface-shader-param-inherit.png)
...
![](/img/visren/prog-guide/surface-shader-param-types.png)
