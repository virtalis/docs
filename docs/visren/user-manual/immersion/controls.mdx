...
![](/img/visren/user-manual/immersion/controls/xbox.png)
...
![](/img/visren/user-manual/immersion/controls/touch.png)
...
![](/img/visren/user-manual/immersion/controls/wmr.png)
...
![](/img/visren/user-manual/immersion/controls/hololens2.png)
...
![](/img/visren/user-manual/immersion/controls/menu.png)

You can now press the **Edit** button to change the default bindings, as below.

![](/img/visren/user-manual/immersion/controls/bindings.png)
