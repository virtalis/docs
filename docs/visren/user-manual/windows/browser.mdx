...
![](/img/visren/user-manual/windows/browser/overview.png)
...
| View | Description |
| --- | --- |
| ![](/img/visren/user-manual/windows/browser/large.png) | ![](/img/visren/user-manual/windows/browser/large-icon.png) **Large icons**<br/>Show 96 x 96 px previews and icons of assets followed by their names. |
| ![](/img/visren/user-manual/windows/browser/small.png) | ![](/img/visren/user-manual/windows/browser/small-icon.png) **Small icons**<br/>Show 48 x 48 px previews and icons of assets followed by their names. |
| ![](/img/visren/user-manual/windows/browser/list.png) | ![](/img/visren/user-manual/windows/browser/list-icon.png) **List**<br/>Show 16 x 16 px previews and icons of assets followed by their name and properties. Most of the properties can be edited. |
...
![](/img/visren/user-manual/windows/browser/group.png)
...
![](/img/visren/user-manual/windows/browser/create-asset.png)
