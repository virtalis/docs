...
![](/img/visren/user-manual/windows/diagnostics/overview.png)
...
![](/img/visren/user-manual/windows/diagnostics/statistics.png)
...
![](/img/visren/user-manual/windows/diagnostics/fps.png)
...
![](/img/visren/user-manual/windows/diagnostics/batches.png)
...
![](/img/visren/user-manual/windows/diagnostics/tooltip.png)
...
![](/img/visren/user-manual/windows/diagnostics/gpu-limits.png)
...
![](/img/visren/user-manual/windows/diagnostics/view-cluster.png)
...
![](/img/visren/user-manual/windows/diagnostics/tracking.png)
...
The Tracking tab of the Diagnostics window shows a table with all of the AR markers in your scene and/or detected by your headset. See [Augmented Reality](../immersion/augmented-reality.mdx) for more information about AR support in Visionary Render.
...
![](/img/visren/user-manual/windows/diagnostics/log.png)
...
| Red         | Error       | Typically problems that couldn’t be resolved by Visionary Render and that prevent something important from working or loading. These contain the prefix “[E]”. See [Troubleshooting](../reference/troubleshooting.mdx) for solutions to common errors. |

Here's an example of the different kinds of text:

![](/img/visren/user-manual/windows/diagnostics/key.png)
...
![](/img/visren/user-manual/windows/diagnostics/copy.png)
...
![](/img/visren/user-manual/windows/diagnostics/lua-error.png)
...
![](/img/visren/user-manual/windows/diagnostics/log-cluster.png)
...
![](/img/visren/user-manual/windows/diagnostics/lua-state.png)
...
![](/img/visren/user-manual/windows/diagnostics/support.png)

### Support Form

This section enables you to generate an e-mail ready to be sent to our support team at [<u>support@virtalis.com</u>](mailto:support@virtalis.com).
