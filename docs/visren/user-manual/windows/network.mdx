...
![](/img/visren/user-manual/windows/network/overview.png)
...
![](/img/visren/user-manual/windows/network/enable.png)
...
![](/img/visren/user-manual/windows/network/connect1.png)

![](/img/visren/user-manual/windows/network/connect2.png)
...
![](/img/visren/user-manual/windows/network/active.png)

This shows a list of the connections to the other members in the current collaboration session.

## Voice Chat

![](/img/visren/user-manual/windows/network/voice-chat.png)
...
![](/img/visren/user-manual/windows/network/settings.png)
...
![](/img/visren/user-manual/windows/network/text-chat.png)
...
![](/img/visren/user-manual/windows/network/statistics.png)
