...
![](/img/visren/user-manual/windows/script-editor/overview.png)
...
![](/img/visren/user-manual/windows/script-editor/tab-bar.png)
...
| Icon                           | Description                                         |
|--------------------------------|-----------------------------------------------------|
| ![](/img/visren/user-manual/windows/script-editor/okay.png) | A script with no unsaved changes or compile errors. |
| ![](/img/visren/user-manual/windows/script-editor/unsaved.png) | A script with unsaved changes.                      |
| ![](/img/visren/user-manual/windows/script-editor/errors.png) | A script with compile errors.                       |
...
![](/img/visren/user-manual/windows/script-editor/syntax-highlighting.png)
...
![](/img/visren/user-manual/windows/script-editor/autocomplete.png)
...
![](/img/visren/user-manual/windows/script-editor/registers.png)
...
![](/img/visren/user-manual/windows/script-editor/drag-and-drop.png)
...
![](/img/visren/user-manual/windows/script-editor/output-panel.png)
...
![](/img/visren/user-manual/windows/script-editor/console.png)
...
![](/img/visren/user-manual/windows/script-editor/find.png)

Click on the ![](/img/visren/user-manual/windows/script-editor/find-icon.png) button to show or hide the Find and Replace bar. It can also be shown from the Script Editor with `Ctrl` + `F`.
...
| Match whole word | Ignore any words that contain the search text in them but have other characters.                             |
 a case-sensitive search (i.e. a search for lower case ‘a’ would ignore any capital A’s in the text). |
| Match whole word | Ignore any words that contain the search text in them but have other characters.                             |
