...
![](/img/visren/user-manual/windows/properties/overview.png)
...
The ![](/img/visren/user-manual/windows/properties/prev.png) and ![](/img/visren/user-manual/windows/properties/next.png) buttons navigate backwards and forwards through the selection history. Click on the drop-down arrow to the right of them to open a list of recently selected nodes.

![](/img/visren/user-manual/windows/properties/history.png)

## Subtree Stats

Click on the ![](/img/visren/user-manual/windows/properties/info.png) icon to show or hide subtree statistics for the current selection. This generates a table with a total ancestor node count and counts for each type of node.

![](/img/visren/user-manual/windows/properties/subtree-stats.png)
...
![](/img/visren/user-manual/windows/properties/multiselect1.png)
...
![](/img/visren/user-manual/windows/properties/multiselect2.png)
...
![](/img/visren/user-manual/windows/properties/reset-all.png)
