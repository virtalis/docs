...
![](/img/visren/user-manual/windows/animation-sequencer/overview.png)
...
| Button                                 | Description |
|----------------------------------------|-------------|
| ![](/img/visren/user-manual/windows/animation-sequencer/start.png)  | Seek to start of sequence (`Home`). |
| ![](/img/visren/user-manual/windows/animation-sequencer/end.png)  | Seek to end of sequence (`End`). |
| ![](/img/visren/user-manual/windows/animation-sequencer/prev-frame.png)  | Seek to previous frame (`Up` or `Left Arrow`). |
| ![](/img/visren/user-manual/windows/animation-sequencer/next-frame.png)  | Seek to next frame (`Down` or `Right Arrow`). |
| ![](/img/visren/user-manual/windows/animation-sequencer/play-backward.png)   | Play sequence backwards from current time. |
| ![](/img/visren/user-manual/windows/animation-sequencer/play-forward.png)  | Play sequence forwards from current time. |
| ![](/img/visren/user-manual/windows/animation-sequencer/pause.png)  | Pause sequence at current time. This is shown over the play button whilst a sequence is playing. |
| ![](/img/visren/user-manual/windows/animation-sequencer/loop.png)  | Enable or disable looped playback. |
| ![](/img/visren/user-manual/windows/animation-sequencer/record.png) | In Manual capture mode, record the current state of the track targets. In Continuous or Motion capture mode, start or stop recording. The button is highlighted red whilst recording is in progress. |

### Properties Panel

![](/img/visren/user-manual/windows/animation-sequencer/properties-panel.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/track-list.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/resize.png)

### Timeline

![](/img/visren/user-manual/windows/animation-sequencer/timeline.png)
...
| ![](/img/visren/user-manual/windows/animation-sequencer/time-grip.png) | The Time Grip marks the current sequence position. Drag it along the timeline to animate the sequence. Double-click on it to return to time zero. |
| --- | --- |

### Track View

![](/img/visren/user-manual/windows/animation-sequencer/track-view.png)
...
|----------------------------------------|---------------|----------------------------------------|----------------|
| ![](/img/visren/user-manual/windows/animation-sequencer/keyframe.png) | Keyframe      | ![](/img/visren/user-manual/windows/animation-sequencer/animation.png) | Animation      |
| ![](/img/visren/user-manual/windows/animation-sequencer/custom-action.png) | Custom Action | ![](/img/visren/user-manual/windows/animation-sequencer/property-track.png) | Property Track |
| ![](/img/visren/user-manual/windows/animation-sequencer/audio.png) | Audio         | ![](/img/visren/user-manual/windows/animation-sequencer/sequence-track.png) | Sequence Track |
...
- Press the ­­­­![](/img/visren/user-manual/windows/animation-sequencer/create.png) button in the Sequencer’s titlebar to add a sequence to a selected node. If no suitable nodes are selected, the sequence will be added to the Scenes node.
...
![](/img/visren/user-manual/windows/animation-sequencer/track.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/interpolation.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/orient-to.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/reverse.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/prop-track1.png)

Select the Property Track in the sequencer and open the Properties window (**Ctrl** + **P**).

![](/img/visren/user-manual/windows/animation-sequencer/prop-track2.png)

From the property drop-down, you can select which material property you wish to animate.

![](/img/visren/user-manual/windows/animation-sequencer/prop-track3.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/scene-visuals.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/markers.png)
...
![](/img/visren/user-manual/windows/animation-sequencer/browser1.png)

List view provides controls and information about number of animations, speed, etc.

![](/img/visren/user-manual/windows/animation-sequencer/browser2.png)

## Settings

The Sequencer can be configured via **Settings** > **Animation Sequencer**.

![](/img/visren/user-manual/windows/animation-sequencer/settings.png)
