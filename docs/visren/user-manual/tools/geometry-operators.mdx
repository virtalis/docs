...
![](/img/visren/user-manual/tools/geom-ops/overview.png)
...
![](/img/visren/user-manual/tools/geom-ops/normals.png)
...
| Image | Description |
| --- | --- |
| ![](/img/visren/user-manual/tools/geom-ops/plane.png) | **Plane**<br/>Generates texture coordinates by projecting a plane onto the mesh. |
| ![](/img/visren/user-manual/tools/geom-ops/box.png) | **Box**<br/>Generates texture coordinates by projecting a cube onto the mesh. |
| ![](/img/visren/user-manual/tools/geom-ops/cylinder.png) | **Cylinder**<br/>Generates texture coordinates by projecting a cylinder onto the mesh. |
| ![](/img/visren/user-manual/tools/geom-ops/sphere.png) | **Sphere**<br/>Generates texture coordinates by projecting a sphere onto the mesh. |
| ![](/img/visren/user-manual/tools/geom-ops/linear.png) | **Linear**<br/>Generates texture coordinates by projecting a line onto the mesh. This can be used to apply gradient textures to geometry. |
...
![](/img/visren/user-manual/tools/geom-ops/plane-mapping.png)

A cube with a Plane mapping orientated along the x, y, and z axes.

![](/img/visren/user-manual/tools/geom-ops/sphere-mapping.png)
...
![](/img/visren/user-manual/tools/geom-ops/box-mapping.png)
...
![](/img/visren/user-manual/tools/geom-ops/uv-scale.png)
...
![](/img/visren/user-manual/tools/geom-ops/tessellate.png)
