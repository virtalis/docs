...
![](/img/visren/user-manual/tools/measuring-tool/overview.png)

## Basic Usage

| Step | Description | Image | 
|---|---|---|
| 1 | 1. Click the ![](/img/visren/user-manual/tools/measuring-tool/icon.png) icon in the Toolbar or press `Ctrl` + `2` to enable the Measuring Tool. | ![](/img/visren/user-manual/tools/measuring-tool/toolbar.png) | 
| 2 | 2. The scene cursor should now show a measuring tape icon when hovered over some geometry. | ![](/img/visren/user-manual/tools/measuring-tool/cursor.png) | 
| 3 | 3. Click on the point that you wish to measure from. A marker will be added to that location. If you need to adjust its position, click and drag the marker to move it. |
| 4 | ![](/img/visren/user-manual/tools/measuring-tool/to.png) | 4. Now click on the point that you wish to measure to. A marker will be added to that location and a GUI will appear. The number in white (406.9mm) is the straight-line distance between the two points. (Tip: to add additional measurements, hold Shift and click on some other geometry.) |
| 5 | ![](/img/visren/user-manual/tools/measuring-tool/tree.png) | 5. The measuring points will appear in the Scenes or Developer tree beneath the nodes they are attached to. They can also be shown in the Browser via the Measurements filter. |
...
![](/img/visren/user-manual/tools/measuring-tool/scene-gui.png)

The image shows the 3D GUI. The top row of icons indicates which distances should be displayed on the GUI.

| Image                                 | Description                          |
|---------------------------------------|--------------------------------------|
| ![](/img/visren/user-manual/tools/measuring-tool/distance.png) | Show or hide straight-line distance. |
| ![](/img/visren/user-manual/tools/measuring-tool/x-distance.png) | Show or hide X distance. |
| ![](/img/visren/user-manual/tools/measuring-tool/y-distance.png) | Show or hide Y distance. |
| ![](/img/visren/user-manual/tools/measuring-tool/z-distance.png) | Show or hide Z distance. |
...
![](/img/visren/user-manual/tools/measuring-tool/locked.png)
...
| Image | Description |
| --- | --- |
| ![](/img/visren/user-manual/tools/measuring-tool/dimensions.png) | The image shows a simple example of a dimension. Both the black and white pawns have a measuring point attached to them.The direct distance between them is shown as a yellow line, with the axial distances being shown as green red and blue lines. The numerical display in the centre of the yellow line is a display of the 4 distances – direct, X, Y and Z.This display will rotate to face you and update when either the assemblies are move or the measuring points themselves. |
| ![](/img/visren/user-manual/tools/measuring-tool/coordinates.png) | The same measurement can be changed to display the coordinates of each of the measuring points. You can also remove the X, Y, Z numerical and line displays to simplify the display.You can select and drag either of the two measuring points around the scene. If you drag the point onto part of the screen with no assemblies, then it will remain at the last valid location.The measuring points also have a display which can show the position of the point or the range of movement in each axis over the lifetime of the point. |
| ![](/img/visren/user-manual/tools/measuring-tool/bounds.png) | This is the same dimension from a different angle. This time it shows the bounding box of the dimension. This is enabled in the properties window for the dimension.The red, green, and blue lines are drawn from a different position but show the same distances.The line of icons above the distance is a simple enable/disable of each of the distances. |
...
![](/img/visren/user-manual/tools/measuring-tool/browser.png)
...
![](/img/visren/user-manual/tools/measuring-tool/point.png)
...
| Step | Action | Image |
|------|--------|-------|
| 1 | Hover the cursor over a measuring point and click on it to select it. Once selected, the measuring point will be highlighted orange and a ‘+’ icon will appear below it. (Alternatively, you can select the measuring point in the tree view.) | ![](/img/visren/user-manual/tools/measuring-tool/select-point.png) |
| 2 | Click on the ‘+’ icon to show the menu. | ![](/img/visren/user-manual/tools/measuring-tool/plus.png) |
| 3 | A menu will appear with 3 options: **Coords**, **Range** and **Reset Range**. To hide this menu again, click the ‘-’ icon. | ![](/img/visren/user-manual/tools/measuring-tool/submenu.png) |
...
![](/img/visren/user-manual/tools/measuring-tool/coords.png)
...
![](/img/visren/user-manual/tools/measuring-tool/range.png)
...
![](/img/visren/user-manual/tools/measuring-tool/properties.png)
...
![](/img/visren/user-manual/tools/measuring-tool/snap-to.png)
...
![](/img/visren/user-manual/tools/measuring-tool/settings.png)
