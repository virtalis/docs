...
![](/img/visren/user-manual/3d-view/events/overview.png)
...
![](/img/visren/user-manual/3d-view/events/assembly.png)
...
![](/img/visren/user-manual/3d-view/events/snapshot.png)

### Sequence

When dragging a Sequence from the Developer view or the Browser it will present these options:

![](/img/visren/user-manual/3d-view/events/sequence.png)
...
![](/img/visren/user-manual/3d-view/events/audiosound.png)

### AudioTrack

When dragging an AudioTrack from the Developer tab onto an Action, it will offer the following options:

![](/img/visren/user-manual/3d-view/events/audiotrack.png)
...
![](/img/visren/user-manual/3d-view/events/browser.png)
