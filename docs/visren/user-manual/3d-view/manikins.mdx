...
![](/img/visren/user-manual/3d-view/manikins/overview.png)
...
![](/img/visren/user-manual/3d-view/manikins/create.png)

## Properties

Use the Properties window (`Ctrl` + `P`) to configure the manikin.

![](/img/visren/user-manual/3d-view/manikins/properties.png)
...
| Advanced | Adjust these values to alter the size of a body segment by uniformly scaling the segment. The measurement is the length of each segment. The [Measuring Tool](../tools/measuring-tool.mdx) can be used to verify anthropometric measurements on the manikin model when using **Advanced** Properties. |
...
![](/img/visren/user-manual/3d-view/manikins/browser.png)
...
![](/img/visren/user-manual/3d-view/manikins/toolbar.png)

![](/img/visren/user-manual/3d-view/manikins/settings.png)
...
![](/img/visren/user-manual/3d-view/manikins/target-helpers.png)
...
![](/img/visren/user-manual/3d-view/manikins/multiselect1.png)
...
![](/img/visren/user-manual/3d-view/manikins/multiselect2.png) ![](/img/visren/user-manual/3d-view/manikins/multiselect3.png) ![](/img/visren/user-manual/3d-view/manikins/multiselect4.png) ![](/img/visren/user-manual/3d-view/manikins/multiselect5.png)

### Bone Helpers

In the Properties window, deselect **IK Enabled** to display the individual Manikin Bone Helpers (forward kinematics),

![](/img/visren/user-manual/3d-view/manikins/bone-helpers1.png)
...
![](/img/visren/user-manual/3d-view/manikins/bone-helpers2.png)
...
![](/img/visren/user-manual/3d-view/manikins/hands1.png)

![](/img/visren/user-manual/3d-view/manikins/hands2.png)
...
![](/img/visren/user-manual/3d-view/manikins/hands3.png)
...
![](/img/visren/user-manual/3d-view/manikins/hands4.png)

![](/img/visren/user-manual/3d-view/manikins/hands5.png)
