...
![](/img/visren/user-manual/3d-view/groups/overview.png)
...
![](/img/visren/user-manual/3d-view/groups/settings.png)

The new Group then appears at the bottom of the Scenes tree view and can be renamed as required.

![](/img/visren/user-manual/3d-view/groups/tree.png)
...
![](/img/visren/user-manual/3d-view/groups/properties.png)
...
![](/img/visren/user-manual/3d-view/groups/buttons.png)
...
![](/img/visren/user-manual/3d-view/groups/group-member.png)
...
![](/img/visren/user-manual/3d-view/groups/snapshot.png)
...
![](/img/visren/user-manual/3d-view/groups/capture1.png) ![](/img/visren/user-manual/3d-view/groups/capture2.png)
...
| ![](/img/visren/user-manual/3d-view/groups/group-icon.png) | This is the default icon used for a Group. It can be changed to a different icon using the same method as for Viewpoints. |
|---------------------------------|---------------------------------------------------------------------------------------------------------------------------|

![](/img/visren/user-manual/3d-view/groups/browser1.png)
...
| ![](/img/visren/user-manual/3d-view/groups/snapshot-icon.png) | This is the default icon used for a Snapshot. It can be changed to a different icon using the same method as for Viewpoints. |
|---------------------------------|------------------------------------------------------------------------------------------------------------------------------|

![](/img/visren/user-manual/3d-view/groups/browser2.png)
...
![](/img/visren/user-manual/3d-view/groups/activation.png)

:::note
They can also be used within the Event handling system and within a Lua Script. This is covered in the [Programming Guide](../../prog-guide/introduction.mdx).
:::
