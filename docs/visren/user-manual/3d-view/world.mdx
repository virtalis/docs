...
![](/img/visren/user-manual/3d-view/world/overview.png)
...
![](/img/visren/user-manual/3d-view/world/properties.png)
...
![](/img/visren/user-manual/3d-view/world/ocean1.png)
...
![](/img/visren/user-manual/3d-view/world/ocean2.png)
...
![](/img/visren/user-manual/3d-view/world/ocean3.png)

![](/img/visren/user-manual/3d-view/world/ocean4.png)
...
![](/img/visren/user-manual/3d-view/world/skybox1.png)
...
![](/img/visren/user-manual/3d-view/world/skybox2.png)
...
![](/img/visren/user-manual/3d-view/world/skybox3.png)
...
![](/img/visren/user-manual/3d-view/world/infinite1.png)

Use the Clip Bottom property to clip the bottom face of Infinite skyboxes.

![](/img/visren/user-manual/3d-view/world/infinite2.png)
...
![](/img/visren/user-manual/3d-view/world/box1.png)

With box, you need to set the boundary size and position of the box and adjust to suit.

![](/img/visren/user-manual/3d-view/world/box2.png)
...
![](/img/visren/user-manual/3d-view/world/fog.png)
...
![](/img/visren/user-manual/3d-view/world/rain1.png)

When enabled a particle system is created that provides a rain effect.

![](/img/visren/user-manual/3d-view/world/rain2.png)
...
![](/img/visren/user-manual/3d-view/world/scale.png)
