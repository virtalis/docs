...
![](/img/visren/user-manual/3d-view/assembly-nodes/overview.png)
...
![](/img/visren/user-manual/3d-view/assembly-nodes/world-transform.png)

This can be changed to transform the Assembly relative to the world origin instead of to its ancestors.

## Apply Transformation

![](/img/visren/user-manual/3d-view/assembly-nodes/apply.png)
...
![](/img/visren/user-manual/3d-view/assembly-nodes/constraints.png)
...
![](/img/visren/user-manual/3d-view/assembly-nodes/limits.png)
...
![](/img/visren/user-manual/3d-view/assembly-nodes/look-at.png)

## Pivots

![](/img/visren/user-manual/3d-view/assembly-nodes/pivots.png)
...
![](/img/visren/user-manual/3d-view/assembly-nodes/edit.png)
...
![](/img/visren/user-manual/3d-view/assembly-nodes/settings.png)
