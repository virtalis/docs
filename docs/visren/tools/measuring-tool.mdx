...
![](/img/visren/tools/measuring-tool/overview.png)

## Basic Usage

| Step | Description | Image | 
|---|---|---|
| 1 | 1. Click the ![](/img/visren/tools/measuring-tool/icon.png) icon in the Toolbar or press `Ctrl` + `2` to enable the Measuring Tool. | ![](/img/visren/tools/measuring-tool/toolbar.png) | 
| 2 | 2. The scene cursor should now show a measuring tape icon when hovered over some geometry. | ![](/img/visren/tools/measuring-tool/cursor.png) | 
...
![](/img/visren/tools/measuring-tool/scene-gui.png)

The image shows the 3D GUI. The top row of icons indicates which distances should be displayed on the GUI.

| Image                                 | Description                          |
|---------------------------------------|--------------------------------------|
| ![](/img/visren/tools/measuring-tool/distance.png) | Show or hide straight-line distance. |
| ![](/img/visren/tools/measuring-tool/x-distance.png) | Show or hide X distance. |
| ![](/img/visren/tools/measuring-tool/y-distance.png) | Show or hide Y distance. |
| ![](/img/visren/tools/measuring-tool/z-distance.png) | Show or hide Z distance. |
...
![](/img/visren/tools/measuring-tool/locked.png)
...
![](/img/visren/tools/measuring-tool/browser.png)
...
![](/img/visren/tools/measuring-tool/point.png)
...
| Step | Action | Image |
|------|--------|-------|
| 1 | Hover the cursor over a measuring point and click on it to select it. Once selected, the measuring point will be highlighted orange and a ‘+’ icon will appear below it. (Alternatively, you can select the measuring point in the tree view.) | ![](/img/visren/tools/measuring-tool/select-point.png) |
| 2 | Click on the ‘+’ icon to show the menu. | ![](/img/visren/tools/measuring-tool/plus.png) |
| 3 | A menu will appear with 3 options: **Coords**, **Range** and **Reset Range**. To hide this menu again, click the ‘-’ icon. | ![](/img/visren/tools/measuring-tool/submenu.png) |
...
![](/img/visren/tools/measuring-tool/coords.png)
...
![](/img/visren/tools/measuring-tool/range.png)
...
![](/img/visren/tools/measuring-tool/properties.png)
...
![](/img/visren/tools/measuring-tool/snap-to.png)
...
![](/img/visren/tools/measuring-tool/settings.png)
