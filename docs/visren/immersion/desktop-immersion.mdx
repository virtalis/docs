...
![](/img/visren/immersion/desktop/toolbar.png)
...
![](/img/visren/immersion/desktop/settings.png)
...
7. If you need to reconnect at any time you can do so by pressing the Reconnect button on the connection status window. If a loss of connection is detected then Visionary Render will automatically try to reconnect to the HoloLens. ![](/img/visren/immersion/desktop/dialog.png)
