...
![](/img/visren/getting-started/user-interface/overview.png)

## Windows

### Title Bar

![](/img/visren/getting-started/user-interface/titlebar.png)
...
| Button | Description |
|--------|-------------|
| ![](/img/visren/getting-started/user-interface/help.png) | Show the help cursor so that you can click on part of the GUI to bring up its relevant section in this manual. You can also open it at the first page with `F1`. |
| ![](/img/visren/getting-started/user-interface/pin.png) / ![](/img/visren/getting-started/user-interface/unpin.png) | Make the window roll up automatically when focus is returned to the 3D scene. |
| ![](/img/visren/getting-started/user-interface/minimise.png) / ![](/img/visren/getting-started/user-interface/restore.png) | Roll the window up to just its titlebar or restore it. |
| ![](/img/visren/getting-started/user-interface/maximise.png) / ![](/img/visren/getting-started/user-interface/restore.png) | Maximise the window to fill the screen or restore it down. |
| ![](/img/visren/getting-started/user-interface/close.png) | Close or dock the window. |
...
![](/img/visren/getting-started/user-interface/stack.png)
...
![](/img/visren/getting-started/user-interface/progress.png)
