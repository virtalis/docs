...
![](/img/visren/3d-view/point-clouds/overview.png)
...
![](/img/visren/3d-view/point-clouds/converter.png)
...
![](/img/visren/3d-view/point-clouds/add1.png)

A file dialog will be shown as below.

![](/img/visren/3d-view/point-clouds/add2.png)
...
![](/img/visren/3d-view/point-clouds/add3.png)
...
![](/img/visren/3d-view/point-clouds/remove.png)
...
![](/img/visren/3d-view/point-clouds/configure1.png)
...
![](/img/visren/3d-view/point-clouds/configure2.png)
...
![](/img/visren/3d-view/point-clouds/configure3.png)
...
![](/img/visren/3d-view/point-clouds/run1.png)
...
![](/img/visren/3d-view/point-clouds/run2.png)

## Import

Once your data is converted, open Visionary Render and create an Assembly.

![](/img/visren/3d-view/point-clouds/import1.png)
...
![](/img/visren/3d-view/point-clouds/import2.png)
...
|----------------------------------------|------------------------------------------------------------------------------|
| ![](/img/visren/3d-view/point-clouds/import3.png) | Original file has red, green, and blue values for each point.                |
| ![](/img/visren/3d-view/point-clouds/import4.png) | Display the point cloud with no colour – disabling the Use Colour Attribute. |
| ![](/img/visren/3d-view/point-clouds/import5.png) | Using a Gradient image to colour the points depending on their altitude.     |
...
![](/img/visren/3d-view/point-clouds/dynamic-sections.png)
...
![](/img/visren/3d-view/point-clouds/settings.png)
