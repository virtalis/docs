...
![](/img/visren-prog/vs-new-dll.png)

Open the Configuration Manager
![](/img/visren-prog/vs-config-mgr.png)

Edit the Active Solution Platforms
![](/img/visren-prog/vs-edit-platform.png)

Remove the x86 platform
![](/img/visren-prog/vs-del-x86.png)

Open the project properties
![](/img/visren-prog/vs-project-props.png)
...
![](/img/visren-prog/vs-cpp-incdir.png)
...
![](/img/visren-prog/vs-link-dir.png)
...
![](/img/visren-prog/vs-link-deps.png)

Add a cpp file (e.g. main.cpp)
![](/img/visren-prog/vs-add-main.png)
...
![](/img/visren-prog/hello-diagnostics.png)
