...
![](/img/programming-guide/surface_shader_click_drag_apply.png)
...
![](/img/programming-guide/surface_shader_instance_applied.png)

#### 2. Right-Click on a Material and select "Create -> Surface Shader Instance". 

![](/img/programming-guide/surface_shader_create.png)
...
![](/img/programming-guide/surface_shader_param_inherit.png)
...
![](/img/programming-guide/surface_shader_param_types.png)
