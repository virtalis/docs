...
![](/img/programming-guide/vs_new_dll.png)

Open the Configuration Manager
![](/img/programming-guide/vs_config_mgr.png)

Edit the Active Solution Platforms
![](/img/programming-guide/vs_edit_platform.png)

Remove the x86 platform
![](/img/programming-guide/vs_del_x86.png)

Open the project properties
![](/img/programming-guide/vs_project_props.png)
...
![](/img/programming-guide/vs_cpp_incdir.png)
...
![](/img/programming-guide/vs_link_dir.png)
...
![](/img/programming-guide/vs_link_deps.png)

Add a cpp file (e.g. main.cpp)
![](/img/programming-guide/vs_add_main.png)
...
:::note
See the <a href="https://cmake.org/cmake/help/latest/">CMake Docs</a> for further information.
:::
...
The following boilerplate code can be used to compile a native plugin starting point. This example makes use of the @ref VRPLUGIN_API_IMPL macro, which handles the boilerplate for hooking into the application log functions and other utilities detailed @ref api_plugin_utils "here".
...
The `VRInit` function is called when the plugin is loaded. The `VRPCleanup` function is called when the plugin is unloaded. It is important that the cleanup function correctly removes things added by the plugin. For more information see @ref dynamic_loading.
...
For more information about other locations where plugins may be located, see @ref plugin_directories.
...
![](/img/programming-guide/hello_diagnostics.png)
