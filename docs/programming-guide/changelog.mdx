...
- Updates the function signatures of ::vrAddNodeObserver and ::vrAddMetaNodeObserver. The old versions have been deprecated. See @ref lua_observers_howto for more information.
...
- Adds the @ref api_exchange "VR Exchange API"
...
| Deprecated Function                 | Replacement (if any)                     |
| ----------------------------------- | ---------------------------------------- |
