...
![](/img/programming-guide/script-editor.png)
...
| Icon                  | Description |
| --------------------- | ----------- |
| <img src="/img/programming-guide/script-editor-script-icon.png"/> | A script with no unsaved changes or compile errors. |
| <img src="/img/programming-guide/script-editor-save-icon.png"/>   | A script with unsaved changes. |
| <img src="/img/programming-guide/script-editor-broken-icon.png"/> | A script with compile errors. |
...
![](/img/programming-guide/script-editor-find.png)

Click on the <img src="/img/programming-guide/script-editor-search-icon.png"/> button to show or hide the Find and Replace bar. It can also be shown from the Script Editor with `Ctrl` + `F`.
