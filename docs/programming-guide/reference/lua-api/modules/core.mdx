...
| void | **[vrExtractBinaryAssets](#vrextractbinaryassets)**([vrnode](../classes/vrnode.mdx) fromNode, string path, boolean overwrite =true)<br />Extracts binary data from texture or audio nodes.  |
