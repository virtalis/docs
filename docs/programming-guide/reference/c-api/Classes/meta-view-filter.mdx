...
|                | Name           |
| -------------- | -------------- |
| enum| **[BlendMode](../Classes/struct_meta___view_filter.mdx#enum-blendmode)** { BlendMode_None, BlendMode_Alpha, BlendMode_Add, BlendMode_Multiply}<br />Values for Idx_BlendMode.  |
| enum| **[IDX](../Classes/struct_meta___view_filter.mdx#enum-idx)** { Idx_Enabled, Idx_Shader, Idx_BlendMode} |
...
| Idx_BlendMode | | [BlendMode](../Classes/struct_meta___view_filter.mdx#enum-blendmode) (int) - controls how shader output is blended with the framebuffer contents.   |
