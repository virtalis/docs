---
title: Meta_OpenVRViewport
summary: An OpenVRViewport represents a viewport occupying a specified rectangle of a window (range 0 to 1) which renders the 3D scene using the projection and distortion calculated by the OpenVR SDK. 
...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___open_v_r_viewport.mdx#enum-idx)** { Idx_Enabled, Idx_Rectangle, Idx_Camera, Idx_ClipRange, Idx_MirrorFillWindow, Idx_MirrorSplitScreen, Idx_DrawMirror, Idx_InterleavedReprojection} |
