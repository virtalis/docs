...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___oculus_viewport.mdx#enum-idx)** { Idx_Enabled, Idx_Rectangle, Idx_Camera, Idx_ClipRange, Idx_MirrorFillWindow, Idx_DrawMirror}<br />Property index.  |
