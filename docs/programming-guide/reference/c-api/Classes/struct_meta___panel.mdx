...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___panel.mdx#enum-idx)** { Idx_Enabled, Idx_Position, Idx_Size, Idx_Style, Idx_AnimLength}<br />Property index.  |
| enum| **[SizingMode](../Classes/struct_meta___panel.mdx#enum-sizingmode)** { SizingMode_Fixed = 0, SizingMode_FitX = VTBIT(0), SizingMode_FitY = VTBIT(1), SizingMode_FitZ = VTBIT(2), SizingMode_FitXY = SizingMode_FitX | SizingMode_FitY, SizingMode_FitXZ = SizingMode_FitX | SizingMode_FitZ, SizingMode_FitYZ = SizingMode_FitY | SizingMode_FitZ, SizingMode_FitXYZ = SizingMode_FitX | SizingMode_FitY | SizingMode_FitZ}<br />Values for Idx_SizingMode properties on most panel-like controls ([Meta_Stack, [Meta_Button](../Classes/struct_meta___button.mdx), etc)  |
...
Values for Idx_SizingMode properties on most panel-like controls ([Meta_Stack, [Meta_Button](../Classes/struct_meta___button.mdx), etc) 
