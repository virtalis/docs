...
An AudioSound represents a "one-shot" playback method for [Meta_AudioBuffer](../Classes/struct_meta___audio_buffer.mdx) nodes.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___audio_sound.mdx#enum-idx)** { Idx_AudioBuffer, Idx_Activate, Idx_Gain, Idx_Relative, Idx_RelativeTo, Idx_Directional}<br />Property index.  |
| enum| **[RelativeTo](../Classes/struct_meta___audio_sound.mdx#enum-relativeto)** { World, Local}<br />Values for Idx_RelativeTo.  |
...
An AudioSound represents a "one-shot" playback method for [Meta_AudioBuffer](../Classes/struct_meta___audio_buffer.mdx) nodes. 
