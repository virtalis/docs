...
|                | Name           |
| -------------- | -------------- |
| enum| **[AXISALIGNMODE](../Classes/struct_meta___dynamic_section.mdx#enum-axisalignmode)** { AxisAlignMode_xy, AxisAlignMode_xz, AxisAlignMode_yz, AxisAlignMode_custom}<br />Values for Idx_AlignMode.  |
| enum| **[IDX](../Classes/struct_meta___dynamic_section.mdx#enum-idx)** { Idx_Enabled, Idx_EnableCaps, Idx_Visible, Idx_Inverted, Idx_Selected, Idx_AlignMode, Idx_SectionLink, Idx_AssemblyLink, Idx_CornerBotLeft, Idx_CornerBotRight, Idx_CornerTopRight, Idx_CornerTopLeft, Idx_Plane, Idx_Opacity}<br />Property index.  |
...
| Idx_AlignMode | | [AXISALIGNMODE](../Classes/struct_meta___dynamic_section.mdx#enum-axisalignmode) (int) - Change the orientation of the clip plane.   |
