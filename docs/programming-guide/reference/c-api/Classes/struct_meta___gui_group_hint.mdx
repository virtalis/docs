...
|                | Name           |
| -------------- | -------------- |
| enum| **[@16](../Classes/struct_meta___gui_group_hint.mdx#enum-@16)** { Idx_VisibleCondition, Idx_ExpandCaption, Idx_Group, Idx_ExpandedByDefault, Idx_Indented, Idx_CustomType} |
