...
|                | Name           |
| -------------- | -------------- |
| enum| **[ALIGNMODE](../Classes/struct_meta___billboard.mdx#enum-alignmode)** { AlignMode_World, AlignMode_Camera, AlignMode_Screen, AlignMode_Camera_X, AlignMode_Camera_Y, AlignMode_Camera_Z}<br />Values for Idx_AlignMode.  |
| enum| **[IDX](../Classes/struct_meta___billboard.mdx#enum-idx)** { Idx_Enabled, Idx_Target, Idx_AlignMode, Idx_PositionMode, Idx_SizeMode, Idx_ShareMode, Idx_WorldPosition, Idx_WorldDepthAdjustment, Idx_ViewPosition, Idx_ScreenPosition, Idx_WorldScale, Idx_ViewScale, Idx_PixelScale, Idx_MinimumScale, Idx_MaximumScale, Idx_NoCollisions, Idx_MaxViewDistance, Idx_UseWorldUpVector, Idx_KeepHorizontal}<br />Property index.  |
| enum| **[POSITIONMODE](../Classes/struct_meta___billboard.mdx#enum-positionmode)** { PositionMode_World, PositionMode_View, PositionMode_Screen}<br />Values for Idx_PositionMode.  |
| enum| **[SIZEMODE](../Classes/struct_meta___billboard.mdx#enum-sizemode)** { SizeMode_World, SizeMode_View, SizeMode_Pixels}<br />Values for Idx_SizeMode.  |
...
| Idx_AlignMode | | [ALIGNMODE](../Classes/struct_meta___billboard.mdx#enum-alignmode) (int) - Specifies the alignment mode   |
