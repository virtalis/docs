...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___g_u_i_material.mdx#enum-idx)** { Idx_LayerValue, Idx_Colour, Idx_Texture, Idx_DepthWrite, Idx_DepthTest, Idx_SubPixelAntiAlias, Idx_PremultipliedAlpha}<br />Property index.  |
| enum| **[Layer](../Classes/struct_meta___g_u_i_material.mdx#enum-layer)** { Opaque, Transparent, SceneOverlay, ViewOverlay}<br />Values for the X element of Idx_LayerValue.  |
