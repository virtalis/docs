...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___annotation.mdx#enum-idx)** { Idx_Enabled, Idx_TargetAssembly, Idx_DefaultViewpoint, Idx_CommentsVisible, Idx_CreatedBy, Idx_Position, Idx_Rotation, Idx_EnterSnapShot, Idx_LeaveSnapShot} |
