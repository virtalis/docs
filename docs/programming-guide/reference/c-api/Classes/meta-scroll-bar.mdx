...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___scroll_bar.mdx#enum-idx)** { Idx_Enabled, Idx_Position, Idx_SizingMode, Idx_Size, Idx_Style, Idx_Type, Idx_Minimum, Idx_Maximum, Idx_Length, Idx_Step, Idx_Value}<br />Property index.  |
| enum| **[SliderType](../Classes/struct_meta___scroll_bar.mdx#enum-slidertype)** { SLIDERTYPE_HORIZONTAL, SLIDERTYPE_VERTICAL}<br />Types for Idx_Type.  |
