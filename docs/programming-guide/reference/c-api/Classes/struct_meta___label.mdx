...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___label.mdx#enum-idx)** { Idx_Enabled, Idx_Position, Idx_SizingMode, Idx_Size, Idx_Text, Idx_AutoWrap, Idx_Draggable, Idx_Style, Idx_ToolTip, Idx_ToolTipStyle} |
