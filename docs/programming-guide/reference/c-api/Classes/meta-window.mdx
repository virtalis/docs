...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___window.mdx#enum-idx)** { Idx_ViewportLayout, Idx_MessageBoxRegion, Idx_GUIEnabled, Idx_GUIEnabledExcludeNode, Idx_Zoom, Idx_NormalRect, Idx_FrameMode, Idx_Maximized, Idx_Minimized, Idx_Stereo3DModeOverride}<br />Property index.  |
