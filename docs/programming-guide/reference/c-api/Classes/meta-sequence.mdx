...
A sequence is a collection of tracks that animate target nodes Valid child types: [Meta_AssemblyTrack](../Classes/struct_meta___assembly_track.mdx), [Meta_PropertyTrack](../Classes/struct_meta___property_track.mdx), [Meta_SequenceTrack. 
...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___sequence.mdx#enum-idx)** { Idx_Enabled, Idx_Position, Idx_Length, Idx_PlayMode, Idx_PlayCount, Idx_PlaySpeed, Idx_FixedPlaySpeed, Idx_PlayUser, Idx_InitialState, Idx_InitialPosition, Idx_DisableSceneVisuals, Idx_DisableActions, Idx_Looped, Idx_LoopStart, Idx_LoopEnd}<br />Property index.  |
| enum| **[InitialState](../Classes/struct_meta___sequence.mdx#enum-initialstate)** { STATE_PAUSE, STATE_PLAY_FORWARDS, STATE_PLAY_BACKWARDS}<br />Values for Idx_InitialState.  |
| enum| **[PlayMode](../Classes/struct_meta___sequence.mdx#enum-playmode)** { PLAY_FORWARDS, PLAY_BACKWARDS}<br />Values for Idx_PlayMode.  |
