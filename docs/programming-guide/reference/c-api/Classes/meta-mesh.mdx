...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___mesh.mdx#enum-idx)** { Idx_Enabled, Idx_NeedsTexCoords, Idx_NeedsTangents, Idx_DrawTangentBasis}<br />Property index.  |
...
Each Mesh node contains data about the mesh stored in [Meta_VertexAttrib](../Classes/struct_meta___vertex_attrib.mdx) and [Meta_IndexPrim](../Classes/struct_meta___index_prim.mdx) nodes; vertices, indices, normals, texture coordinates, etc. 
