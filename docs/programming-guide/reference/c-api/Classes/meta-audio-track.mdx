...
An AudioTrack provides full control over playback and looping of data in a [Meta_AudioBuffer](../Classes/struct_meta___audio_buffer.mdx).  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___audio_track.mdx#enum-idx)** { Idx_AudioBuffer, Idx_State, Idx_Gain, Idx_Loop, Idx_Relative, Idx_RelativeTo, Idx_Directional}<br />Property Index.  |
| enum| **[RelativeTo](../Classes/struct_meta___audio_track.mdx#enum-relativeto)** { World, Local}<br />Values for Idx_RelativeTo.  |
| enum| **[State](../Classes/struct_meta___audio_track.mdx#enum-state)** { Stopped, Playing, Paused}<br />Values for Idx_State.  |
...
An AudioTrack provides full control over playback and looping of data in a [Meta_AudioBuffer](../Classes/struct_meta___audio_buffer.mdx). 
...
| ---------- | ----- | ----------- |
| Idx_AudioBuffer | | link - [Meta_AudioBuffer](../Classes/struct_meta___audio_buffer.mdx) containing the audio data we want this sound to play   |
