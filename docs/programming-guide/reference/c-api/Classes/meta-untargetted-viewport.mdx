...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___untargetted_viewport.mdx#enum-idx)** { Idx_Enabled, Idx_Rectangle, Idx_Camera, Idx_ViewMatrix_Mono, Idx_ViewMatrix_Left, Idx_ViewMatrix_Right, Idx_ProjectionMatrix_Mono, Idx_ProjectionMatrix_Left, Idx_ProjectionMatrix_Right}<br />Property index.  |
