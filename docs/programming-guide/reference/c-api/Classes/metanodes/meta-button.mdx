...
A Button is a clickable GUI object which can trigger actions via [Meta_EventHandler](../metanodes/meta-event-handler.mdx) children, or a [Meta_GUIPropertyLink](../metanodes/meta-gui-property-link.mdx). 
...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[IDX](#enum-idx)** { Idx_Enabled, Idx_Position, Idx_SizingMode, Idx_Size, Idx_Text, Idx_Image, Idx_Toggle, Idx_ToggledImage, Idx_Draggable, Idx_RadioGroup, Idx_Style, Idx_Toggled, Idx_ToolTip, Idx_ToolTipStyle, Idx_Permission}<br />Property index.  |
...
| Idx_Style | | link - Style to apply to the button ([Meta_ColouredButtonStyle](../metanodes/meta-coloured-button-style.mdx), [Meta_TexturedButtonStyle](../metanodes/meta-textured-button-style.mdx))   |
