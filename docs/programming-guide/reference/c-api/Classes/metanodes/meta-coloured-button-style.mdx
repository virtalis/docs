...
A ColouredButtonStyle provides flat [Meta_Button](../metanodes/meta-button.mdx) colours as well as button content layout controls. 
...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[IDX](#enum-idx)** { Idx_BGColour_normal, Idx_BGColour_hovering, Idx_BGColour_pressed, Idx_BGColour_toggled, Idx_TextSize, Idx_TextPadding, Idx_TextColour, Idx_Font, Idx_ImageSize, Idx_ImagePosition, Idx_HAlign, Idx_VAlign, Idx_Borders}<br />Property index.  |
