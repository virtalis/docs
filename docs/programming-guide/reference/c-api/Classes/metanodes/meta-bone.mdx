...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[Axis](#enum-axis)** { AxisX, AxisY, AxisZ, AxisXNeg, AxisYNeg, AxisZNeg}<br />Values for the Axis property.  |
| enum| **[IDX](#enum-idx)** { Idx_Enabled, Idx_Transform, Idx_IKEnabled, Idx_Axis, Idx_Offset, Idx_ResetBeforeSolving, Idx_DefaultRotation, Idx_Depth, Idx_LinkedAssembly, Idx_Target, Idx_TargetTranslationOnly, Idx_Request} |
