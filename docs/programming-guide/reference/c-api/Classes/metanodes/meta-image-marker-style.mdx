...
| Type           | Name           |
| -------------- | -------------- |
| void | **[AddIgnoreProbes](#addignoreprobes)**([HMigration](../../definitions/types.mdx#typedef-hmigration) ) |
| void | **[RemoveHitTestRadius](#removehittestradius)**([HMigration](../../definitions/types.mdx#typedef-hmigration) ) |
...
| Idx_Material | | link - Material to use when Idx_UseMaterialColour is true. Using a material means there are no highlight colour distinctions. ([Meta_StdMaterial, [Meta_GUIMaterial](../metanodes/meta-gui-material.mdx), [Meta_WaterMaterial)   |
