...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[EyeOverride](#enum-eyeoverride)** { EyeOverride_None = -1, EyeOverride_Mono = 0, EyeOverride_Left = 1, EyeOverride_Right = 2}<br />Values for Idx_EyeOverride.  |
| enum| **[IDX](#enum-idx)** { Idx_Enabled, Idx_Rectangle, Idx_Camera, Idx_ProjectionMode, Idx_Screen_Mono, Idx_Screen_Left, Idx_Screen_Right, Idx_FOV, Idx_ScreenWidth, Idx_ScreenOffset, Idx_HMD, Idx_OrthographicZoom, Idx_EyeOverride, Idx_Mirror}<br />Property index.  |
| enum| **[ProjectionMode](#enum-projectionmode)** { ProjectionMode_PhysicalScreen, ProjectionMode_FOVAndWidth, ProjectionMode_Orthographic}<br />Values for Idx_ProjectionMode.  |
...
| Idx_EyeOverride | | [EyeOverride](../metanodes/meta-viewport.mdx#enum-eyeoverride) (int) - Overrides the eye drawn by this viewport   |
