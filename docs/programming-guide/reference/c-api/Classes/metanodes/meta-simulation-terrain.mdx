...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[IDX](#enum-idx)** { Idx_Enabled, Idx_ElevationPath, Idx_MainImageryPath, Idx_AuxImageryPath, Idx_ImageryEnabled, Idx_ImageryBlend, Idx_Lighting, Idx_Reflectivity, Idx_Shininess, Idx_Metalness, Idx_Ambient, Idx_Grid, Idx_TileLODThreshold}<br />Property index.  |
