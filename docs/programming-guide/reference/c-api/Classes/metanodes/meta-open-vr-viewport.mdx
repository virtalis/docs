...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[IDX](#enum-idx)** { Idx_Enabled, Idx_Rectangle, Idx_Camera, Idx_ClipRange, Idx_MirrorFillWindow, Idx_MirrorSplitScreen, Idx_DrawMirror, Idx_InterleavedReprojection} |
