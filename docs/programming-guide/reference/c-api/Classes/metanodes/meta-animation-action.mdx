...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[IDX](#enum-idx)** \{ Idx_RelTime, Idx_Type \}<br />Property index.  |
| enum| **[Type](#enum-type)** \{ TYPE_CUSTOM, TYPE_ENABLE, TYPE_DISABLE, TYPE_SOUND \}<br />Values for Idx_Type.  |
...
Valid child types: [Meta_EventHandler](../metanodes/meta-event-handler.mdx), [Meta_AudioBuffer](../metanodes/meta-audio-buffer.mdx), [Meta_AudioSound](../metanodes/meta-audio-sound.mdx)
