...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___z_space_viewport.mdx#enum-idx)** { Idx_Enabled, Idx_Rectangle, Idx_Camera, Idx_ProjectionMode, Idx_Screen_Mono, Idx_Screen_Left, Idx_Screen_Right, Idx_FOV, Idx_ScreenWidth, Idx_ScreenOffset, Idx_HMD, Idx_EyeOverride}<br />Property index.  |
