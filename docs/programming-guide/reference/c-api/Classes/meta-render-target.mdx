...
|                | Name           |
| -------------- | -------------- |
| enum| **[Attachment](../Classes/struct_meta___render_target.mdx#enum-attachment)** { Depth, Stencil, DepthStencil, Colour} |
| enum| **[CubeMapFace](../Classes/struct_meta___render_target.mdx#enum-cubemapface)** { PosX, NegX, PosY, NegY, PosZ, NegZ} |
| enum| **[IDX](../Classes/struct_meta___render_target.mdx#enum-idx)** { Idx_Enabled, Idx_Attachment, Idx_Texture, Idx_MipLevel, Idx_Layer, Idx_Clear, Idx_ClearValue} |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[Meta_RenderTarget](../Classes/struct_meta___render_target.mdx#meta-rendertarget)**() |
