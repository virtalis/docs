...
|                | Name           |
| -------------- | -------------- |
| enum| **[CollideReport](../Classes/struct_meta___collision.mdx#enum-collidereport)** { REPORT_QUIET = 1, REPORT_INVQUIET = 2, REPORT_NORMAL = (REPORT_QUIET | REPORT_INVQUIET)}<br />Values for Idx_Report.  |
| enum| **[CollideType](../Classes/struct_meta___collision.mdx#enum-collidetype)** { TYPE_DEFAULT = GROUP_DEFAULT   | ((0xffff & ~(GROUP_PICKING | GROUP_PICKABLE | GROUP_CAMERA)) << 16), TYPE_PICKING = GROUP_PICKING   | (GROUP_PICKABLE << 16), TYPE_PICKABLE = GROUP_PICKABLE  | (GROUP_PICKING << 16), TYPE_CAMERA = GROUP_CAMERA    | ((0xffff & ~(GROUP_PICKING | GROUP_PICKABLE | GROUP_CAMERA)) << 16), TYPE_ALL = ~0}<br />Values for Idx_Type.  |
| enum| **[IDX](../Classes/struct_meta___collision.mdx#enum-idx)** { Idx_State, Idx_Mode, Idx_Geometry, Idx_Sphere, Idx_BBox, Idx_Ray, Idx_RayLength, Idx_CollisionResponse, Idx_Report, Idx_Type, Idx_Visible, Idx_CollideCount, Idx_Mass, Idx_Restitution, Idx_Friction, Idx_PrivateShape, Idx_CylindricalShape, Idx_Offset}<br />Property index.  |
| enum| **[ShapeMode](../Classes/struct_meta___collision.mdx#enum-shapemode)** { MODE_GEOMETRY_BBOX, MODE_BBOX, MODE_SPHERE, MODE_VISUAL, MODE_RAY, MODE_RAY_PENETRATING, MODE_GEOMETRY_CONVEX_DECOMPOSITION, MODE_CYLINDER, MODE_CAPSULE, MODE_CONE}<br />Values for Idx_Mode.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| const int | **[GROUP_CAMERA](../Classes/struct_meta___collision.mdx#group-camera)** <br />defines a collision group for cameras  |
| const int | **[GROUP_DEFAULT](../Classes/struct_meta___collision.mdx#group-default)** <br />defines a standard collision group; DEFAULT objects collide with everything other than PICKING and PICKABLE objects  |
| const int | **[GROUP_HELPERS](../Classes/struct_meta___collision.mdx#group-helpers)** <br />defines a collision group for immersive helpers that require collision with the avatar but with not the picking rays  |
| const int | **[GROUP_PICKABLE](../Classes/struct_meta___collision.mdx#group-pickable)** <br />defines a Mockup compatible collide group; PICKABLE objects only collide with PICKING objects  |
| const int | **[GROUP_PICKING](../Classes/struct_meta___collision.mdx#group-picking)** <br />defines a Mockup compatible collide group; PICKING objects only collide with PICKABLE objects  |
| const int | **[GROUP_SYSTEM](../Classes/struct_meta___collision.mdx#group-system)** <br />defines a collide group for the systems always on picking - Skinnies without a Fat sibling  |
| const int | **[GROUP_VISUAL](../Classes/struct_meta___collision.mdx#group-visual)** <br />defines a collision group for Skinny bodies that have a Fat sibling - always the visual mesh  |
