...
|                | Name           |
| -------------- | -------------- |
| enum| **[IDX](../Classes/struct_meta___reflection_probe.mdx#enum-idx)** { Idx_Enabled, Idx_Resolution, Idx_ProxyType, Idx_ProxySize, Idx_Shadows, Idx_UpdateMode, Idx_UpdateAndStoreNow, Idx_Texture, Idx_Mode, Idx_BakedTexture}<br />Property index.  |
| enum| **[ProbeMode](../Classes/struct_meta___reflection_probe.mdx#enum-probemode)** { Probe_Bake, Probe_Custom}<br />Values for Idx_Mode.  |
| enum| **[ProxyType](../Classes/struct_meta___reflection_probe.mdx#enum-proxytype)** { Proxy_None, Proxy_Ellipsoid, Proxy_Box}<br />Values for Idx_ProxyType.  |
| enum| **[UpdateMode](../Classes/struct_meta___reflection_probe.mdx#enum-updatemode)** { Update_Auto, Update_Always, Update_Manual}<br />Values for Idx_UpdateMode.  |
