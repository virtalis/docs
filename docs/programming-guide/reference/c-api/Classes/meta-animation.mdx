...
|                | Name           |
| -------------- | -------------- |
| enum| **[Axis](../Classes/struct_meta___animation.mdx#enum-axis)** { AXIS_POSITIVE_X, AXIS_POSITIVE_Y, AXIS_POSITIVE_Z, AXIS_NEGATIVE_X, AXIS_NEGATIVE_Y, AXIS_NEGATIVE_Z}<br />Values for Idx_Axis.  |
| enum| **[AxisOrder](../Classes/struct_meta___animation.mdx#enum-axisorder)** { AXIS_ORDER_XYZ, AXIS_ORDER_YZX, AXIS_ORDER_ZXY, AXIS_ORDER_XZY, AXIS_ORDER_YXZ, AXIS_ORDER_ZYX}<br />Values for Idx_AxisOrder.  |
| enum| **[IDX](../Classes/struct_meta___animation.mdx#enum-idx)** { Idx_Interpolation, Idx_OrientTo, Idx_LookAtTarget, Idx_Axis, Idx_RotationMethod, Idx_AxisOrder}<br />Property index.  |
| enum| **[Interpolation](../Classes/struct_meta___animation.mdx#enum-interpolation)** { INTERPOLATION_CONSTANT, INTERPOLATION_LINEAR, INTERPOLATION_CATMULL_ROM}<br />Values for Idx_Interpolation.  |
| enum| **[OrientTo](../Classes/struct_meta___animation.mdx#enum-orientto)** { ORIENT_TO_KEYFRAMES, ORIENT_TO_PATH, ORIENT_TO_TARGET, ORIENT_TO_PATH_PLUS_KEYFRAMES, ORIENT_TO_TARGET_PLUS_KEYFRAMES}<br />Values for Idx_OrientTo.  |
| enum| **[RotationMethod](../Classes/struct_meta___animation.mdx#enum-rotationmethod)** { ROTATION_METHOD_QUATERNION, ROTATION_METHOD_EULER_ANGLES}<br />Values for Idx_RotationMethod.  |
...
Valid child types: [Meta_AnimationFramePRS](../Classes/struct_meta___animation_frame_p_r_s.mdx), Meta_AnimationFrameBool, Meta_AnimationFrameInt, Meta_AnimationFrameFloat, Meta_AnimationFrameDouble, Meta_AnimationFrameWorldFloat, Meta_AnimationFrameString, Meta_AnimationFrameLink, [Meta_AnimationAction](../Classes/struct_meta___animation_action.mdx)
...
| Idx_Axis | | [Axis](../Classes/struct_meta___animation.mdx#enum-axis) (int) - The axis of rotation to use when orienting to a path or target   |
| Idx_RotationMethod | | [RotationMethod (int) - Whether to apply keyframe rotations with quaternions or Euler angles   |
| Idx_AxisOrder | | [AxisOrder](../Classes/struct_meta___animation.mdx#enum-axisorder) (int) - The order to apply Euler angles. This affects how the animation interpolates between keyframes   |
