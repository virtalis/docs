...
<LiteYouTubeEmbed id="kAa8NgO8jwg" params="autoplay=1&autohide=1&showinfo=0&rel=0" title="Visionary Render - A Virtalis Software" poster="maxresdefault" webp />
```
...
:::note
This manual is aimed at a general audience and requires no prior knowledge. To learn about writing scripts and code, see the [Visionary Render Programming Guide](../visionary-render-programming).
:::
