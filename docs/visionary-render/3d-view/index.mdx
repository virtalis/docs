...
![](/img/visionary-render/3d-view/3d-view/overview.png)
...
![](/img/visionary-render/3d-view/3d-view/stereo-cursor.png)
...
| ![](/img/visionary-render/3d-view/3d-view/selection1.png) | ![](/img/visionary-render/3d-view/3d-view/selection2.png) |
|-------------------------|-------------------------|
...
| ![](/img/visionary-render/3d-view/3d-view/region-select1.png)                                                                                                         | ![](/img/visionary-render/3d-view/3d-view/region-select2.png)                                                                                               |
|---------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
...
| Action                   | Description                                                                                                                                                                                                                                                                                       |
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/visionary-render/3d-view/3d-view/mouse1.png)  | Hold down Middle button and move the mouse forward or backward to move in to or out from the current view, or left and right to swivel the view.                                                                                                                                                  |
| ![](/img/visionary-render/3d-view/3d-view/mouse2.png)  | Hold down Middle + Right button and move the mouse to pan the view up or down, left or right.                                                                                                                                                                                                     |
| ![](/img/visionary-render/3d-view/3d-view/mouse3.png)  | Hold down Shift + Middle button and move the mouse forward or backward to tilt the view, or left and right to swivel.                                                                                                                                                                             |
| ![](/img/visionary-render/3d-view/3d-view/mouse4.png) | Hold down Ctrl + Middle button and move the mouse to orbit selected Assemblies left or right, up or down.                                                                                                                                                                                         |
| ![](/img/visionary-render/3d-view/3d-view/mouse5.png) | Scroll the Mouse wheel to zoom in to or out from the cursor. Hold down Ctrl to increase the zoom speed or Shift to change the field of view instead (if the viewport supports this). Zooming can be enabled or disabled from the Settings window under `User Interface` > `Mouse` > `Scroll Wheel Zoom`. |

#### Keyboard

| Action        | Keys                                                          | Action     | Keys                                                          |
|---------------|---------------------------------------------------------------|------------|---------------------------------------------------------------|
| Move Forward  | ![](/img/visionary-render/3d-view/3d-view/keyboard1.png)                                | Turn Left  | ![](/img/visionary-render/3d-view/3d-view/keyboard2.png)                                |
| Move Backward | ![](/img/visionary-render/3d-view/3d-view/keyboard3.png)                                | Turn Right | ![](/img/visionary-render/3d-view/3d-view/keyboard4.png)                                |
| Move Up       | ![](/img/visionary-render/3d-view/3d-view/keyboard5.png)                                | Move Left  | ![](/img/visionary-render/3d-view/3d-view/keyboard6.png) ![](/img/visionary-render/3d-view/3d-view/keyboard2.png) |
| Move Down     | ![](/img/visionary-render/3d-view/3d-view/keyboard7.png)                                | Move Right | ![](/img/visionary-render/3d-view/3d-view/keyboard6.png) ![](/img/visionary-render/3d-view/3d-view/keyboard4.png) |
| Look Up       | ![](/img/visionary-render/3d-view/3d-view/keyboard6.png) ![](/img/visionary-render/3d-view/3d-view/keyboard5.png) | Look Down  | ![](/img/visionary-render/3d-view/3d-view/keyboard6.png) ![](/img/visionary-render/3d-view/3d-view/keyboard7.png) |
...
| Action                   | Response                                        |
|--------------------------|-------------------------------------------------|
| ![](/img/visionary-render/3d-view/3d-view/spacemouse1.png) | Move the view forward or backward in the scene. |
| ![](/img/visionary-render/3d-view/3d-view/spacemouse2.png) | Pan the view left or right in the scene.        |
| ![](/img/visionary-render/3d-view/3d-view/spacemouse3.png) | Pan the view up or down in the scene.           |
| ![](/img/visionary-render/3d-view/3d-view/spacemouse4.png) | Tilt the view to look up or down.               |
| ![](/img/visionary-render/3d-view/3d-view/spacemouse5.png) | Swivel the view to look left or right.          |
| ![](/img/visionary-render/3d-view/3d-view/spacemouse6.png) | Unassigned.                                     |
...
![](/img/visionary-render/3d-view/3d-view/spacemouse7.png)
...
![](/img/visionary-render/3d-view/3d-view/context-menu.png)
...
| ![](/img/visionary-render/3d-view/3d-view/flyto1.png) | ![](/img/visionary-render/3d-view/3d-view/flyto2.png) |
|--------------------------|--------------------------|
| Before                   | After                    |
...
| ![](/img/visionary-render/3d-view/3d-view/lookat1.png) | ![](/img/visionary-render/3d-view/3d-view/lookat2.png) |
|--------------------------|--------------------------|
| Before                   | After                    |

## Viewpoints

Visionary Render can save and recall present view positions in the scene. They can be used to display key aspects of the scene being displayed. Viewpoints are a type of Assembly used to store an interesting or important view in the scene. They are identified in the Scenes tree by the ![](/img/visionary-render/3d-view/3d-view/viewpoints1.png) icon.
...
![](/img/visionary-render/3d-view/3d-view/viewpoints2.png)

The second method uses the Browser window to create a new viewpoint using the context menu.

![](/img/visionary-render/3d-view/3d-view/viewpoints3.png)
...
![](/img/visionary-render/3d-view/3d-view/viewpoints4.png)
...
![](/img/visionary-render/3d-view/3d-view/viewpoints5.png)
...
![](/img/visionary-render/3d-view/3d-view/viewpoints6.png)
...
![](/img/visionary-render/3d-view/3d-view/viewpoints7.png)
...
![](/img/visionary-render/3d-view/3d-view/viewpoints8.png)
...
![](/img/visionary-render/3d-view/3d-view/viewpoints9.png)
...
![](/img/visionary-render/3d-view/3d-view/viewpoints10.png)
...
| Shape                                 | Description                                                                                                                                                                          |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/visionary-render/3d-view/3d-view/plane.png) | **Plane**<br/>A plane in the XZ axis (i.e. facing the sky). ~1m x 1m.                                                                                                                      |
| ![](/img/visionary-render/3d-view/3d-view/cube.png) | **Cube**<br/>An axis-aligned cube. ~1m x 1m x 1m.                                                                                                                                          |
| ![](/img/visionary-render/3d-view/3d-view/sphere.png) | **Sphere**<br/>A sphere composed of 1482 triangles. ~1m in diameter.                                                                                                                       |
| ![](/img/visionary-render/3d-view/3d-view/cubic-sphere.png) | **Cubic Sphere**<br/>A sphere with a flat surface projected onto it. ~1m in diameter.                                                                                                      |
| ![](/img/visionary-render/3d-view/3d-view/disc.png) | **Disc**<br/>A disc in the XZ axis (i.e. facing the sky). ~1m in diameter.                                                                                                                 |
| ![](/img/visionary-render/3d-view/3d-view/cone.png) | **Cone**<br/>A cone with its tip pointing to the sky. ~1m x 1m x 1m.                                                                                                                       |
| ![](/img/visionary-render/3d-view/3d-view/cylinder.png) | **Cylinder**<br/>A cylinder with its faces pointing to the sky and ground. ~1m x 1m x 1m.                                                                                                  |
| ![](/img/visionary-render/3d-view/3d-view/torus.png) | **Torus**<br/>A surface of revolution generated by revolving a circle in three-dimensional space about an axis coplanar to it (or, more intuitively, a “doughnut” shape). ~1m x 0.3m x 1m. |
| ![](/img/visionary-render/3d-view/3d-view/torus-knot.png) | **Torus Knot**<br/>A special kind of knot that lies on the surface of an unknotted torus in three-dimensional space. ~1.6m x 1.2m x 1.7m.                                                  |
| ![](/img/visionary-render/3d-view/3d-view/arrow.png) | **Arrow**<br/>A composite shape made up of a cuboid and pyramid. It points along the negative Z axis by default. ~0.25m x 0.25m x 1m.                                                      |
| ![](/img/visionary-render/3d-view/3d-view/room.png) | **Room**<br/>A room composed of 6 individual plane assemblies. ~1m x 1m x 1m.                                                                                                              |
| ![](/img/visionary-render/3d-view/3d-view/axis.png) | **Axis**<br/>A 4-part assembly that can be used to visually represent a coordinate system. ~0.23m x 0.23m x 0.23m.                                                                         |

### Super-Quadrics

There's also a sub-menu with options for creating various super-quadrics (i.e. 3D parametric objects).

![](/img/visionary-render/3d-view/3d-view/super-quadrics.png)
...
| ![](/img/visionary-render/3d-view/3d-view/scene-tooltips1.png) | ![](/img/visionary-render/3d-view/3d-view/scene-tooltips2.png) |
|--------------------------|--------------------------|
...
Visionary Render supports stereo 3D. It can be enabled from the ![](/img/visionary-render/3d-view/3d-view/stereo1.png) button in the Toolbar or by pressing **F10**. Stereo is achieved by rendering the 3D view twice, once into each eye, at different camera angles.

### Settings

Stereo can be configured for the Settings window under `Renderer` > `General`.

![](/img/visionary-render/3d-view/3d-view/stereo2.png)
...
![](/img/visionary-render/3d-view/3d-view/stereo3.png) ![](/img/visionary-render/3d-view/3d-view/stereo4.png)
...
![](/img/visionary-render/3d-view/3d-view/drag-and-drop.png)
