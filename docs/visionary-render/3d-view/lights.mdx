...
![](/img/visionary-render/3d-view/lights/light-probe1.png)
...
![](/img/visionary-render/3d-view/lights/light-probe2.png)
...
![](/img/visionary-render/3d-view/lights/reflection-probe.png)
...
![](/img/visionary-render/3d-view/lights/helpers.png)

| Helper                                | Description                                                                                                                 |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| ![](/img/visionary-render/3d-view/lights/spot-light.png) | Spot light icon and helper showing direction and spread angle                                                               |
| ![](/img/visionary-render/3d-view/lights/point-light.png) | Point light icon and helper show the location and radius of the spread – no indication of direction as its omnidirectional. |
| ![](/img/visionary-render/3d-view/lights/directional-light.png) | Directional light icon – show direction.                                                                                    |
| ![](/img/visionary-render/3d-view/lights/ambient-light.png) | Ambient light icon – no direction as its global illumination without direction.                                             |
