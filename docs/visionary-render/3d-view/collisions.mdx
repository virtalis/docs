...
The character controller can be enabled by clicking on the ![](/img/visionary-render/3d-view/collisions/character.png) button in the Toolbar. It creates a capsule around your avatar to detect when it collides with the environment. This is enabled by default in the Start Room and is what permits you to walk around the room and up and down the stairs, etc. without walking through objects and walls.

![](/img/visionary-render/3d-view/collisions/overview.png)
...
![](/img/visionary-render/3d-view/collisions/properties.png)
...
![](/img/visionary-render/3d-view/collisions/kinematic.png)
...
![](/img/visionary-render/3d-view/collisions/context-menu.png)
...
![](/img/visionary-render/3d-view/collisions/tools.png)
...
![](/img/visionary-render/3d-view/collisions/tree.png)
