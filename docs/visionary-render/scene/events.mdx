...
![](/img/visionary-render/scene/events/overview.webp)
...
![](/img/visionary-render/scene/events/assembly.webp)
...
![](/img/visionary-render/scene/events/snapshot.webp)

### Sequence

When dragging a Sequence from the Developer view or the Browser it will present these options:

![](/img/visionary-render/scene/events/sequence.webp)
...
![](/img/visionary-render/scene/events/browser.webp)
