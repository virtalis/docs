...
![](/img/visionary-render/scene/web-browser/overview.webp)
...
|---|---|
| Address | The address of the initial page to show in the web browser texture. |
| Texture Size | The size of the web browser texture in pixels (width x height). |
