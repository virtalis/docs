...
The character controller can be enabled by clicking on the ![](/img/visionary-render/scene/collisions/character.webp) button in the Toolbar. It creates a capsule around your avatar to detect when it collides with the environment. This is enabled by default in the Start Room and is what permits you to walk around the room and up and down the stairs, etc. without walking through objects and walls.

![](/img/visionary-render/scene/collisions/overview.webp)
...
![](/img/visionary-render/scene/collisions/properties.webp)
...
![](/img/visionary-render/scene/collisions/kinematic.webp)
...
![](/img/visionary-render/scene/collisions/context-menu.webp)
...
![](/img/visionary-render/scene/collisions/tools.webp)
...
![](/img/visionary-render/scene/collisions/tree.webp)
