...
![](/img/visionary-render/scene/media/audio-buffer1.png) ![](/img/visionary-render/scene/media/audio-buffer2.png)
...
![](/img/visionary-render/scene/media/audio-sound.png)
...
![](/img/visionary-render/scene/media/audio-sound-properties.png)
...
![](/img/visionary-render/scene/media/audio-track-properties.png)
...
![](/img/visionary-render/scene/media/audio-browser.png)
...
![](/img/visionary-render/scene/media/movie1.png) ![](/img/visionary-render/scene/media/movie2.png)
...
![](/img/visionary-render/scene/media/movie3.png)
...
![](/img/visionary-render/scene/media/movie-browser.png)
...
![](/img/visionary-render/scene/media/movie-rig1.png)
...
![](/img/visionary-render/scene/media/movie-rig2.png)
...
![](/img/visionary-render/scene/media/movie-rig3.png)
...
![](/img/visionary-render/scene/media/material1.png)
...
|---|---|
| ![](/img/visionary-render/scene/media/material2.png) | Normal UV mapping – simple 1:1. The Map Matrix is left as the default. |
| ![](/img/visionary-render/scene/media/material3.png) | Zoomed in on a specific portion of the movie. The Map Matrix has had the scale and position modified. |
| ![](/img/visionary-render/scene/media/material4.png) | Movie rotation 90º. The Map Matrix has a rotation added in the Z axis and translated in the Y axis. |
...
![](/img/visionary-render/scene/media/chroma-key1.png)

Next drag the Movie or image into the Chroma Key Texture Source.

![](/img/visionary-render/scene/media/chroma-key2.png)
...
![](/img/visionary-render/scene/media/chroma-key3.png)
...
![](/img/visionary-render/scene/media/chroma-key4.png)
...
![](/img/visionary-render/scene/media/chroma-key5.png)
...
![](/img/visionary-render/scene/media/chroma-key6.png)
...
![](/img/visionary-render/scene/media/pdf1.png) ![](/img/visionary-render/scene/media/pdf2.png)
...
![](/img/visionary-render/scene/media/pdf3.png)
...
![](/img/visionary-render/scene/media/word1.png) ![](/img/visionary-render/scene/media/word2.png)
...
![](/img/visionary-render/scene/media/word3.png)
