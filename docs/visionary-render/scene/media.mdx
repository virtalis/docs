...
Visionary Render permits you to insert various audio, video, and document file formats into your scenes, including WAV, MP4, DOCX and PDF.

## Audio

Visionary Render provides audio support through its audio buffer node and can introduce positional and distance-attenuated sound 
into your scenes using two systems: audio sounds and audio tracks. Positional sound means the audio originates from a specific point in the scene and is heard relative to your camera position. Distance attenuation refers to the volume reduction applied based on how far the sound source is from the camera.

:::note
Positional and distance-attenuated audio only work with mono (single-channel) audio files. Stereo files do not support these spatial audio effects.
:::
...
![](/img/visionary-render/scene/media/audio-buffer1.webp) ![](/img/visionary-render/scene/media/audio-buffer2.webp)
...
An audio sound is designed for sound effects that are relatively short and played once. There is no way to stop playing back an audio sound once it has started. You also cannot adjust its volume, modify any of its properties, or even move it in 3D space once it has started playing. Any property changes made to the audio sound component will affect future activations, not sounds that are already playing.

Apart from this behavior, it functions similarly to an audio track. Audio sound is best suited for sound effects such as gunshots, door knocks, impacts, or other quick sound cues where no runtime control is required.

#### Create

After creating an audio buffer, right-click on the Scenes node in the Developer tree and select **Create** > **Media** > **Audio Track** from the context menu to create an audio sound.

![](/img/visionary-render/scene/media/audio-sound.webp)

:::tip
It is often good practice to place audio sounds and audio tracks under an Assembly to ensure they are correctly placed in the scene, unless the sound is attached to the camera.
:::

#### Properties

![](/img/visionary-render/scene/media/audio-sound-properties.webp)

| Property | Description |
|---|---|
| Audio Buffer | Link to an AudioBuffer in the Library tree whose audio file should be played. |
| Activate | Plays the sound back once just now. The sound will play until it is finished. |
...
Audio tracks function as reusable audio playback components. They reserve the necessary audio resources for as long as the track node exists and provide basic playback controls such as start, pause, and stop through their state property. Because the audio sources remain allocated for the track’s entire lifecycle, any changes made to the node’s properties - such as volume, looping, 
or other parameters - take effect immediately on the currently playing audio. Audio tracks are ideal for continuous or ambient sounds, especially those positioned at the listener or camera, such as looping rain, wind, or other environmental effects.

#### Create

After creating an audio buffer, right-click on the Scenes node in the Developer tree and select **Create** > **Media** > **Audio Track** from the context menu to create an audio track.

![](/img/visionary-render/scene/media/audio-sound.webp)

#### Properties

![](/img/visionary-render/scene/media/audio-track-properties.webp)

| Property |Description |
|---|---|
| Audio Buffer | Link to an AudioBuffer in the Library tree whose audio file should be played. |
| State | The current state of the track (**Stopped**, **Playing** or **Paused**). |
| Volume | The volume of the sound. |
...
![](/img/visionary-render/scene/media/audio-browser.webp)
...
![](/img/visionary-render/scene/media/movie1.webp) ![](/img/visionary-render/scene/media/movie2.webp)

| Property | Description |
|---|---|
| Filename/URL | The relative filename of the movie file. |
| Playing | Is the movie currently |
...
![](/img/visionary-render/scene/media/movie3.webp)
...
![](/img/visionary-render/scene/media/movie-browser.webp)
...
![](/img/visionary-render/scene/media/movie-rig1.webp)
...
![](/img/visionary-render/scene/media/movie-rig2.webp)
...
![](/img/visionary-render/scene/media/movie-rig3.webp)
...
![](/img/visionary-render/scene/media/material1.webp)
...
|---|---|
| ![](/img/visionary-render/scene/media/material2.webp) | Normal UV mapping – simple 1:1. The Map Matrix is left as the default. |
| ![](/img/visionary-render/scene/media/material3.webp) | Zoomed in on a specific portion of the movie. The Map Matrix has had the scale and position modified. |
| ![](/img/visionary-render/scene/media/material4.webp) | Movie rotation 90º. The Map Matrix has a rotation added in the Z axis and translated in the Y axis. |

Multiple materials can reference the same Movie instance. When the Movie is played, all materials using that movie will show the movie playing.
...
![](/img/visionary-render/scene/media/chroma-key1.webp)

Next drag the Movie or image into the Chroma Key Texture Source.

![](/img/visionary-render/scene/media/chroma-key2.webp)
...
![](/img/visionary-render/scene/media/chroma-key3.webp)
...
![](/img/visionary-render/scene/media/chroma-key4.webp)
...
![](/img/visionary-render/scene/media/chroma-key5.webp)
...
![](/img/visionary-render/scene/media/chroma-key6.webp)
...
![](/img/visionary-render/scene/media/pdf1.webp) ![](/img/visionary-render/scene/media/pdf2.webp)
...
![](/img/visionary-render/scene/media/pdf3.webp)
...
![](/img/visionary-render/scene/media/word1.webp) ![](/img/visionary-render/scene/media/word2.webp)
...
![](/img/visionary-render/scene/media/word3.webp)
