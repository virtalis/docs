...
Visionary Render exposes various settings that can be tweaked to improve the performance of the renderer (and therefore your scenes). The **Geometry Operators** and **Diagnostics** sections describe how to diagnose and optimise the models in your scenes. However, if your scene still isn't rendering quickly enough then this section will cover some additional renderer-specific settings that you can tweak to try and improve performance. These settings can be found in the Settings window (`F6`) under the **Renderer** category.

## General

![](/img/visionary-render/renderer/performance-settings/general.png)
...
![](/img/visionary-render/renderer/performance-settings/scene.png)
...
![](/img/visionary-render/renderer/performance-settings/lod.png)
