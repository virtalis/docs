...
Visionary Render supports stereo 3D. It can be enabled from the ![](/img/visionary-render/renderer/stereo-3d/stereo1.png) button in the Toolbar or by pressing **F10**. Stereo is achieved by rendering the 3D view twice, once into each eye, at different camera angles.

## Settings

Stereo can be configured for the Settings window under `Renderer` > `General`.

![](/img/visionary-render/renderer/stereo-3d/stereo2.png)
...
![](/img/visionary-render/renderer/stereo-3d/stereo3.png) ![](/img/visionary-render/renderer/stereo-3d/stereo4.png)
