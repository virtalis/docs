...
Visionary Render supports stereo 3D. It can be enabled from the ![](/img/visionary-render/renderer/stereo-3d/button.webp) button in the Toolbar or by pressing **F10**. Stereo is achieved by rendering the 3D view twice, once into each eye, at different camera angles.

## Settings

Stereo can be configured from the Settings window under **Renderer** > **General**.

![](/img/visionary-render/renderer/stereo-3d/settings.webp)
...
![](/img/visionary-render/renderer/stereo-3d/tree.webp) ![](/img/visionary-render/renderer/stereo-3d/properties.webp)
