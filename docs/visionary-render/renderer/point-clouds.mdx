...
![](/img/visionary-render/renderer/point-clouds/overview.webp)
...
![](/img/visionary-render/renderer/point-clouds/converter.webp)
...
![](/img/visionary-render/renderer/point-clouds/add1.webp)

A file dialog will be shown as below.

![](/img/visionary-render/renderer/point-clouds/add2.webp)
...
![](/img/visionary-render/renderer/point-clouds/add3.webp)
...
![](/img/visionary-render/renderer/point-clouds/remove.webp)
...
![](/img/visionary-render/renderer/point-clouds/configure1.webp)
...
![](/img/visionary-render/renderer/point-clouds/configure2.webp)
...
![](/img/visionary-render/renderer/point-clouds/configure3.webp)
...
![](/img/visionary-render/renderer/point-clouds/run1.webp)
...
![](/img/visionary-render/renderer/point-clouds/run2.webp)

## Import

Once your data is converted, open Visionary Render and create an Assembly.

![](/img/visionary-render/renderer/point-clouds/import1.webp)
...
![](/img/visionary-render/renderer/point-clouds/import2.webp)
...
|----------------------------------------|------------------------------------------------------------------------------|
| ![](/img/visionary-render/renderer/point-clouds/import3.webp) | Original file has red, green, and blue values for each point.                |
| ![](/img/visionary-render/renderer/point-clouds/import4.webp) | Display the point cloud with no colour – disabling the Use Colour Attribute. |
| ![](/img/visionary-render/renderer/point-clouds/import5.webp) | Using a Gradient image to colour the points depending on their altitude.     |
...
![](/img/visionary-render/renderer/point-clouds/dynamic-sections.webp)
...
![](/img/visionary-render/renderer/point-clouds/settings.webp)
