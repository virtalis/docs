...
![](/img/visionary-render/renderer/particle-systems/overview1.webp) ![](/img/visionary-render/renderer/particle-systems/overview2.webp) ![](/img/visionary-render/renderer/particle-systems/overview3.webp)
...
![](/img/visionary-render/renderer/particle-systems/create1.webp)
...
![](/img/visionary-render/renderer/particle-systems/create2.webp)
...
![](/img/visionary-render/renderer/particle-systems/preview.webp)
...
![](/img/visionary-render/renderer/particle-systems/properties.webp)
...
| Tiling Mode | Tiling allows you to specify part of a texture to split into a grid. The options are **None**, **Random**, **Animated** and **Animated Random**. When selected, you can specify the number of rows and columns for the texture tiles. For this to work well, ensure that your texture is evenly spaced in a grid format. ![](/img/visionary-render/renderer/particle-systems/tiling-mode1.webp)<br/>With animated and animated random, you also have an animation speed. ![](/img/visionary-render/renderer/particle-systems/tiling-mode2.webp)<br/>An example image would be akin to the Muybridge footage that shows 16 frames of animation of a horse running. With set animation, at 4x4, the animation moves along the top row at the speed specified before dropping a row and continuing. This cycle repeats. ![](/img/visionary-render/renderer/particle-systems/tiling-mode3.webp) |
| Billboard Mode | Selecting between XY or XZ determines the direction the billboard faces. |
| Orient U/V | Orientation is apparent when using random direction for particle systems. When specified, it will align the texture in the direction of emission. In this example, the particles are emitted both up and down. With orient V, the arrows point up and down. ![](/img/visionary-render/renderer/particle-systems/orient-uv1.webp)<br/>Without orientation, the arrows all face the same direction. ![](/img/visionary-render/renderer/particle-systems/orient-uv2.webp) |
...
| Emit Shape | The shape that particles are randomly created within. ![](/img/visionary-render/renderer/particle-systems/emit-shape1.webp)<br/>When specifying a mesh, the mesh used is not the visual element but the sub geo-group level mesh. ![](/img/visionary-render/renderer/particle-systems/emit-shape2.webp) |
| Shape Angle | When cone is selected, a slider defining the Angle range of the emit shape is available. ![](/img/visionary-render/renderer/particle-systems/shape-angle.webp) |
...
| Force | Adding values to force will apply a directional force to particles over lifetime. This would commonly be used to replicate gravity on a fountain water particle system or similar effect. ![](/img/visionary-render/renderer/particle-systems/force.webp) |

### Emission Module

![](/img/visionary-render/renderer/particle-systems/emission-module1.webp)
...
![](/img/visionary-render/renderer/particle-systems/emission-module2.webp)

## Input Functions

![](/img/visionary-render/renderer/particle-systems/input-functions1.webp)
...
![](/img/visionary-render/renderer/particle-systems/input-functions2.webp)

Apply a constant value to a property. A number edit box will be shown as above.

### Min/Max

![](/img/visionary-render/renderer/particle-systems/input-functions3.webp)
...
![](/img/visionary-render/renderer/particle-systems/input-functions4.webp)
...
![](/img/visionary-render/renderer/particle-systems/curve-editor.webp)
...
![](/img/visionary-render/renderer/particle-systems/helpers1.webp) ![](/img/visionary-render/renderer/particle-systems/helpers2.webp) ![](/img/visionary-render/renderer/particle-systems/helpers3.webp)
...
![](/img/visionary-render/renderer/particle-systems/helpers4.webp)
...
![](/img/visionary-render/renderer/particle-systems/helpers5.webp)
