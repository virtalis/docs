...
![](/img/visionary-render/renderer/lights/light-probe1.png)
...
![](/img/visionary-render/renderer/lights/light-probe2.png)
...
![](/img/visionary-render/renderer/lights/reflection-probe.png)
...
![](/img/visionary-render/renderer/lights/helpers.png)

| Helper                                | Description                                                                                                                                      |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/visionary-render/renderer/lights/spot-light.png) | Spot light icon and helper showing direction and spread angle                                                                |
| ![](/img/visionary-render/renderer/lights/point-light.png) | Point light icon and helper show the location and radius of the spread – no indication of direction as its omnidirectional. |
| ![](/img/visionary-render/renderer/lights/directional-light.png) | Directional light icon – show direction.                                                                              |
| ![](/img/visionary-render/renderer/lights/ambient-light.png) | Ambient light icon – no direction as its global illumination without direction.                                           |
