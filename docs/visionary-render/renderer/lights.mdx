...
| Intensity       | An indication of how bright the light is. Normal range is between 0.0 and 1.0, unless inverse square falloff is enabled. |
...
![](/img/visionary-render/renderer/lights/light-probe1.webp)
...
![](/img/visionary-render/renderer/lights/light-probe2.webp)
...
![](/img/visionary-render/renderer/lights/reflection-probe.webp)
...
![](/img/visionary-render/renderer/lights/helpers.webp)

| Helper                                | Description                                                                                                                                      |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/visionary-render/renderer/lights/spot-light.webp) | Spot light icon and helper showing direction and spread angle                                                                |
| ![](/img/visionary-render/renderer/lights/point-light.webp) | Point light icon and helper show the location and radius of the spread – no indication of direction as its omnidirectional. |
| ![](/img/visionary-render/renderer/lights/directional-light.webp) | Directional light icon – show direction.                                                                              |
| ![](/img/visionary-render/renderer/lights/ambient-light.webp) | Ambient light icon – no direction as its global illumination without direction.                                           |
