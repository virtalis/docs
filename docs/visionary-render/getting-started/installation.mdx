...
8. The setup is now complete. Select **Finish** to close the installer. You can now run Visionary Render from the start menu or desktop shortcut (if you chose this option).
