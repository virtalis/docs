...
![](/img/visionary-render/getting-started/user-interface/overview.webp)

## Application Menu

Click on the Virtalis button at the top-left of the Toolbar to open the Application Menu.

![](/img/visionary-render/getting-started/user-interface/app-menu.webp)
...
![](/img/visionary-render/getting-started/user-interface/titlebar.webp)
...
| Button | Description |
|--------|-------------|
| ![](/img/visionary-render/getting-started/user-interface/help.webp) | Show the help cursor so that you can click on part of the GUI to bring up its relevant section in this manual. You can also open it at the first page with `F1`. |
| ![](/img/visionary-render/getting-started/user-interface/pin.webp) / ![](/img/visionary-render/getting-started/user-interface/unpin.webp) | Make the window roll up automatically when focus is returned to the 3D scene. |
| ![](/img/visionary-render/getting-started/user-interface/minimise.webp) / ![](/img/visionary-render/getting-started/user-interface/restore.webp) | Roll the window up to just its titlebar or restore it. |
| ![](/img/visionary-render/getting-started/user-interface/maximise.webp) / ![](/img/visionary-render/getting-started/user-interface/restore.webp) | Maximise the window to fill the screen or restore it down. |
| ![](/img/visionary-render/getting-started/user-interface/close.webp) | Close or dock the window. |
...
![](/img/visionary-render/getting-started/user-interface/stack.webp)
...
![](/img/visionary-render/getting-started/user-interface/progress.webp)
