...
It can be enabled from the ![](/img/visionary-render/tools/snap-home/snap-home.png) button in the Toolbar or by pressing `F4` (it is disabled by default).

| Image | Description |
| --- | --- |
| ![](/img/visionary-render/tools/snap-home/default.png) | The snap home tool works with an assembly which is moved either with the mouse, SpaceMouse or tracked device. |
| ![](/img/visionary-render/tools/snap-home/near.png) | As it moves from its original location, a green ghost version is left in its place. If you release the assembly – either with the right mouse button or tracker device – the assembly will snap back to its original location. |
...
![](/img/visionary-render/tools/snap-home/settings.png)
