...
1. Click the ![](/img/visionary-render/tools/measuring/icon.png) icon in the Toolbar or press `Ctrl` + `2` to enable the Measuring Tool.
   
   ![](/img/visionary-render/tools/measuring/toolbar.png)

2. The scene cursor should now show a measuring tape icon when hovered over some geometry.

   ![](/img/visionary-render/tools/measuring/cursor.png)
...
4. Now click on the point that you wish to measure to. A marker will be added to that location and a GUI will appear. The number in white (406.9mm) is the straight-line distance between the two points. (Tip: to add additional measurements, hold Shift and click on some other geometry.)
   ...
   ![](/img/visionary-render/tools/measuring/to.png)
...
5. The measuring points will appear in the Scenes or Developer tree beneath the nodes they are attached to. They can also be shown in the Browser via the Measurements filter.
   ...
   ![](/img/visionary-render/tools/measuring/tree.png)
...
1. Hover the cursor over a measuring point and click on it to select it. Once selected, the measuring point will be highlighted orange and a `+` icon will appear below it. (Alternatively, you can select the measuring point in the tree view.)
   ...
   ![](/img/visionary-render/tools/measuring/select-point.png)

2. Click on the `+` icon to show the menu.

   ![](/img/visionary-render/tools/measuring/plus.png)

3. A menu will appear with 3 options: **Coords**, **Range** and **Reset Range**. To hide this menu again, click the `-` icon.

   ![](/img/visionary-render/tools/measuring/submenu.png)
