...
![](/img/visionary-render/tools/measuring/overview.webp)

## Basic Usage

<Steps>

1. Click the ![](/img/visionary-render/tools/measuring/icon.webp) icon in the Toolbar or press `Ctrl` + `2` to enable the Measuring Tool.
   
   ![](/img/visionary-render/tools/measuring/toolbar.webp)

2. The scene cursor should now show a measuring tape icon when hovered over some geometry.

   ![](/img/visionary-render/tools/measuring/cursor.webp)
...
4. Now click on the point that you wish to measure to. A marker will be added to that location and a GUI will appear. The number in white (406.9mm) is the straight-line distance between the two points. (Tip: to add additional measurements, hold Shift and click on some other geometry.)
   ...
   ![](/img/visionary-render/tools/measuring/to.webp)
...
5. The measuring points will appear in the Scenes or Developer tree beneath the nodes they are attached to. They can also be shown in the Browser via the Measurements filter.
   ...
   ![](/img/visionary-render/tools/measuring/tree.webp)
...
![](/img/visionary-render/tools/measuring/scene-gui.webp)

The image shows the 3D GUI. The top row of icons indicates which distances should be displayed on the GUI.

| Image                                 | Description                          |
|---------------------------------------|--------------------------------------|
| ![](/img/visionary-render/tools/measuring/distance.webp) | Show or hide straight-line distance. |
| ![](/img/visionary-render/tools/measuring/x-distance.webp) | Show or hide X distance. |
| ![](/img/visionary-render/tools/measuring/y-distance.webp) | Show or hide Y distance. |
| ![](/img/visionary-render/tools/measuring/z-distance.webp) | Show or hide Z distance. |
...
![](/img/visionary-render/tools/measuring/locked.webp)
...
![](/img/visionary-render/tools/measuring/browser.webp)
...
![](/img/visionary-render/tools/measuring/point.webp)
...
1. Hover the cursor over a measuring point and click on it to select it. Once selected, the measuring point will be highlighted orange and a `+` icon will appear below it. (Alternatively, you can select the measuring point in the tree view.)

   ![](/img/visionary-render/tools/measuring/select-point.webp)

2. Click on the `+` icon to show the menu.

   ![](/img/visionary-render/tools/measuring/plus.webp)

3. A menu will appear with 3 options: **Coords**, **Range** and **Reset Range**. To hide this menu again, click the `-` icon.

   ![](/img/visionary-render/tools/measuring/submenu.webp)
...
![](/img/visionary-render/tools/measuring/coords.webp)
...
![](/img/visionary-render/tools/measuring/range.webp)
...
![](/img/visionary-render/tools/measuring/properties.webp)
...
![](/img/visionary-render/tools/measuring/snap-to.webp)
...
![](/img/visionary-render/tools/measuring/settings.webp)
