...
![](/img/visionary-render/tools/measuring-tool/overview.png)

## Basic Usage

| Step | Description | Image | 
|---|---|---|
| 1 | 1. Click the ![](/img/visionary-render/tools/measuring-tool/icon.png) icon in the Toolbar or press `Ctrl` + `2` to enable the Measuring Tool. | ![](/img/visionary-render/tools/measuring-tool/toolbar.png) | 
| 2 | 2. The scene cursor should now show a measuring tape icon when hovered over some geometry. | ![](/img/visionary-render/tools/measuring-tool/cursor.png) | 
...
| 5 | ![](/img/visionary-render/tools/measuring-tool/tree.png) | 5. The measuring points will appear in the Scenes or Developer tree beneath the nodes they are attached to. They can also be shown in the Browser via the Measurements filter. |
...
![](/img/visionary-render/tools/measuring-tool/scene-gui.png)

The image shows the 3D GUI. The top row of icons indicates which distances should be displayed on the GUI.

| Image                                 | Description                          |
|---------------------------------------|--------------------------------------|
| ![](/img/visionary-render/tools/measuring-tool/distance.png) | Show or hide straight-line distance. |
| ![](/img/visionary-render/tools/measuring-tool/x-distance.png) | Show or hide X distance. |
| ![](/img/visionary-render/tools/measuring-tool/y-distance.png) | Show or hide Y distance. |
| ![](/img/visionary-render/tools/measuring-tool/z-distance.png) | Show or hide Z distance. |
...
![](/img/visionary-render/tools/measuring-tool/locked.png)
...
![](/img/visionary-render/tools/measuring-tool/browser.png)
...
![](/img/visionary-render/tools/measuring-tool/point.png)
...
| Step | Action | Image |
|------|--------|-------|
| 1 | Hover the cursor over a measuring point and click on it to select it. Once selected, the measuring point will be highlighted orange and a ‘+’ icon will appear below it. (Alternatively, you can select the measuring point in the tree view.) | ![](/img/visionary-render/tools/measuring-tool/select-point.png) |
| 2 | Click on the ‘+’ icon to show the menu. | ![](/img/visionary-render/tools/measuring-tool/plus.png) |
| 3 | A menu will appear with 3 options: **Coords**, **Range** and **Reset Range**. To hide this menu again, click the ‘-’ icon. | ![](/img/visionary-render/tools/measuring-tool/submenu.png) |
...
![](/img/visionary-render/tools/measuring-tool/coords.png)
...
![](/img/visionary-render/tools/measuring-tool/range.png)
...
![](/img/visionary-render/tools/measuring-tool/properties.png)
...
![](/img/visionary-render/tools/measuring-tool/snap-to.png)
...
![](/img/visionary-render/tools/measuring-tool/settings.png)
