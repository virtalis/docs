...
![](/img/visionary-render/tools/geom-ops/overview.png)
...
![](/img/visionary-render/tools/geom-ops/normals.png)
...
| Image | Description |
| --- | --- |
| ![](/img/visionary-render/tools/geom-ops/plane.png) | **Plane**<br/>Generates texture coordinates by projecting a plane onto the mesh. |
| ![](/img/visionary-render/tools/geom-ops/box.png) | **Box**<br/>Generates texture coordinates by projecting a cube onto the mesh. |
| ![](/img/visionary-render/tools/geom-ops/cylinder.png) | **Cylinder**<br/>Generates texture coordinates by projecting a cylinder onto the mesh. |
| ![](/img/visionary-render/tools/geom-ops/sphere.png) | **Sphere**<br/>Generates texture coordinates by projecting a sphere onto the mesh. |
| ![](/img/visionary-render/tools/geom-ops/linear.png) | **Linear**<br/>Generates texture coordinates by projecting a line onto the mesh. This can be used to apply gradient textures to geometry. |
...
![](/img/visionary-render/tools/geom-ops/plane-mapping.png)

A cube with a Plane mapping orientated along the x, y, and z axes.

![](/img/visionary-render/tools/geom-ops/sphere-mapping.png)
...
![](/img/visionary-render/tools/geom-ops/box-mapping.png)
...
![](/img/visionary-render/tools/geom-ops/uv-scale.png)
...
![](/img/visionary-render/tools/geom-ops/tessellate.png)
