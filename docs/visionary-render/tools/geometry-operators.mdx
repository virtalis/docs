...
![](/img/visionary-render/tools/geometry-operators/overview.webp)
...
![](/img/visionary-render/tools/geometry-operators/normals.webp)
...
| Image | Description |
| --- | --- |
| ![](/img/visionary-render/tools/geometry-operators/plane.webp) | **Plane**<br/>Generates texture coordinates by projecting a plane onto the mesh. |
| ![](/img/visionary-render/tools/geometry-operators/box.webp) | **Box**<br/>Generates texture coordinates by projecting a cube onto the mesh. |
| ![](/img/visionary-render/tools/geometry-operators/cylinder.webp) | **Cylinder**<br/>Generates texture coordinates by projecting a cylinder onto the mesh. |
| ![](/img/visionary-render/tools/geometry-operators/sphere.webp) | **Sphere**<br/>Generates texture coordinates by projecting a sphere onto the mesh. |
| ![](/img/visionary-render/tools/geometry-operators/linear.webp) | **Linear**<br/>Generates texture coordinates by projecting a line onto the mesh. This can be used to apply gradient textures to geometry. |
...
![](/img/visionary-render/tools/geometry-operators/plane-mapping.webp)

A cube with a Plane mapping orientated along the x, y, and z axes.

![](/img/visionary-render/tools/geometry-operators/sphere-mapping.webp)
...
![](/img/visionary-render/tools/geometry-operators/box-mapping.webp)
...
![](/img/visionary-render/tools/geometry-operators/uv-scale.webp)
...
![](/img/visionary-render/tools/geometry-operators/tessellate.webp)
