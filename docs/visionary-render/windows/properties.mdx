...
![](/img/visionary-render/windows/properties/overview.webp)
...
The ![](/img/visionary-render/windows/properties/prev.webp) and ![](/img/visionary-render/windows/properties/next.webp) buttons navigate backwards and forwards through the selection history. Click on the drop-down arrow to the right of them to open a list of recently selected nodes.

![](/img/visionary-render/windows/properties/history.webp)

## Subtree Stats

Click on the ![](/img/visionary-render/windows/properties/info.webp) icon to show or hide subtree statistics for the current selection. This generates a table with a total ancestor node count and counts for each type of node.

![](/img/visionary-render/windows/properties/subtree-stats.webp)
...
![](/img/visionary-render/windows/properties/multiselect1.webp)
...
![](/img/visionary-render/windows/properties/multiselect2.webp)
...
![](/img/visionary-render/windows/properties/reset-all.webp)
