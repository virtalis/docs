...
![](/img/visionary-render/windows/animation-sequencer/overview.webp)
...
| Button                                 | Description |
|----------------------------------------|-------------|
| ![](/img/visionary-render/windows/animation-sequencer/start.webp)  | Seek to start of sequence (`Home`). |
| ![](/img/visionary-render/windows/animation-sequencer/end.webp)  | Seek to end of sequence (`End`). |
| ![](/img/visionary-render/windows/animation-sequencer/prev-frame.webp)  | Seek to previous frame (`Up` or `Left Arrow`). |
| ![](/img/visionary-render/windows/animation-sequencer/next-frame.webp)  | Seek to next frame (`Down` or `Right Arrow`). |
| ![](/img/visionary-render/windows/animation-sequencer/play-backward.webp)   | Play sequence backwards from current time. |
| ![](/img/visionary-render/windows/animation-sequencer/play-forward.webp)  | Play sequence forwards from current time. |
| ![](/img/visionary-render/windows/animation-sequencer/pause.webp)  | Pause sequence at current time. This is shown over the play button whilst a sequence is playing. |
| ![](/img/visionary-render/windows/animation-sequencer/loop.webp)  | Enable or disable looped playback. |
| ![](/img/visionary-render/windows/animation-sequencer/record.webp) | In Manual capture mode, record the current state of the track targets. In Continuous or Motion capture mode, start or stop recording. The button is highlighted red whilst recording is in progress. |

### Properties Panel

![](/img/visionary-render/windows/animation-sequencer/properties-panel.webp)
...
![](/img/visionary-render/windows/animation-sequencer/track-list.webp)
...
![](/img/visionary-render/windows/animation-sequencer/resize.webp)

### Timeline

![](/img/visionary-render/windows/animation-sequencer/timeline.webp)
...
| ![](/img/visionary-render/windows/animation-sequencer/time-grip.webp) | The Time Grip marks the current sequence position. Drag it along the timeline to animate the sequence. Double-click on it to return to time zero. |
| --- | --- |

### Track View

![](/img/visionary-render/windows/animation-sequencer/track-view.webp)
...
|----------------------------------------|---------------|----------------------------------------|----------------|
| ![](/img/visionary-render/windows/animation-sequencer/keyframe.webp) | Keyframe      | ![](/img/visionary-render/windows/animation-sequencer/animation.webp) | Animation      |
| ![](/img/visionary-render/windows/animation-sequencer/custom-action.webp) | Custom Action | ![](/img/visionary-render/windows/animation-sequencer/property-track.webp) | Property Track |
| ![](/img/visionary-render/windows/animation-sequencer/audio.webp) | Audio         | ![](/img/visionary-render/windows/animation-sequencer/sequence-track.webp) | Sequence Track |
...
- Press the ­­­­![](/img/visionary-render/windows/animation-sequencer/create.webp) button in the Sequencer’s titlebar to add a sequence to a selected node. If no suitable nodes are selected, the sequence will be added to the Scenes node.
...
![](/img/visionary-render/windows/animation-sequencer/track.webp)
...
![](/img/visionary-render/windows/animation-sequencer/interpolation.webp)
...
![](/img/visionary-render/windows/animation-sequencer/orient-to.webp)
...
![](/img/visionary-render/windows/animation-sequencer/reverse.webp)
...
![](/img/visionary-render/windows/animation-sequencer/prop-track1.webp)

Select the Property Track in the sequencer and open the Properties window (**Ctrl** + **P**).

![](/img/visionary-render/windows/animation-sequencer/prop-track2.webp)

From the property drop-down, you can select which material property you wish to animate.

![](/img/visionary-render/windows/animation-sequencer/prop-track3.webp)
...
![](/img/visionary-render/windows/animation-sequencer/scene-visuals.webp)
...
![](/img/visionary-render/windows/animation-sequencer/markers.webp)
...
![](/img/visionary-render/windows/animation-sequencer/browser1.webp)

List view provides controls and information about number of animations, speed, etc.

![](/img/visionary-render/windows/animation-sequencer/browser2.webp)

## Settings

The Sequencer can be configured via **Settings** > **Animation Sequencer**.

![](/img/visionary-render/windows/animation-sequencer/settings.webp)
