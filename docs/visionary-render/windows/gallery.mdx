...
![](/img/visionary-render/windows/gallery/overview.webp)
...
The ![](/img/visionary-render/windows/gallery/prev.webp) and ![](/img/visionary-render/windows/gallery/next.webp) buttons at the top-left of the window navigate backwards and forwards through the selection history.
...
![](/img/visionary-render/windows/gallery/remove-category.webp)
...
![](/img/visionary-render/windows/gallery/components.webp)
...
- Right-click on a category and select **Add to favourites** from the context menu.
- Hover the cursor over a category until a star appears at the top-left of the icon. Click on the icon to add the category to your favourites. Note: In the list views, this icon will appear in a column of the list instead.

![](/img/visionary-render/windows/gallery/favourite.webp)
...
![](/img/visionary-render/windows/gallery/search-by-name.webp)
...
![](/img/visionary-render/windows/gallery/search-by-category.webp)
...
![](/img/visionary-render/windows/gallery/search-by-mix.webp)
...
![](/img/visionary-render/windows/gallery/cascade.webp)

The ![](/img/visionary-render/windows/gallery/prev.webp) and ![](/img/visionary-render/windows/gallery/next.webp) buttons at the sides of the preview navigate to the previous or next item in a directory.
...
| Image | Description |
| --- | --- |
| ![](/img/visionary-render/windows/gallery/cascade.webp) | **Cascade**<br/>Overlay all the assets in a category from the top-left to bottom-right of the preview panel. |
| ![](/img/visionary-render/windows/gallery/tile.webp) | **Tile**<br/>Organise the assets in a category as tiles. |
| ![](/img/visionary-render/windows/gallery/first.webp) | **First**<br/>Only show the first asset in a category. |
| ![](/img/visionary-render/windows/gallery/last.webp) | **Last**<br/>Only show the last asset in a category. |

#### Editing Assets

To edit assets in the Browse view, right-click on them to bring up the context menu.

![](/img/visionary-render/windows/gallery/edit.webp)
...
![](/img/visionary-render/windows/gallery/folders.webp)
...
![](/img/visionary-render/windows/gallery/icons.webp)
...
![](/img/visionary-render/windows/gallery/edit-folder.webp)
...
![](/img/visionary-render/windows/gallery/edit-file.webp)
...
![](/img/visionary-render/windows/gallery/preview1.webp)
...
![](/img/visionary-render/windows/gallery/preview2.webp)
...
![](/img/visionary-render/windows/gallery/create.webp)

### Creating a Collection

There are 3 ways to add an asset to a collection:

- Select nodes in the Scenes tree, right-click on them and select **Save to Gallery** from the context menu.
- Select nodes in the Scenes tree and drag them into the empty area of the **Create** tab in the Gallery window.
- Select nodes in the 3D scene and drag them into the empty area of the **Create** tab in the Gallery window.
...
![](/img/visionary-render/windows/gallery/single.webp)
...
![](/img/visionary-render/windows/gallery/multiple.webp)
...
![](/img/visionary-render/windows/gallery/edit-properties.webp)
...
| Image | Description |
| --- | --- |
| ![](/img/visionary-render/windows/gallery/large-icons.webp) |  **Large icons**<br/>Show 96 x 96 px previews and icons of assets followed by their names. |
| ![](/img/visionary-render/windows/gallery/small-icons.webp) |  **Small icons**<br/>Show 48 x 48 px previews and icons of assets followed by their names. |
| ![](/img/visionary-render/windows/gallery/large-list.webp) |  **Large list**<br/>Show 48 x 48 px previews and icons of assets followed by their name and type. Additional columns show the location and description of an asset. |
| ![](/img/visionary-render/windows/gallery/list.webp) |  **List**<br/>Show 16 x 16 px previews and icons of assets followed by their name. Additional columns show the type, location, and description of an asset. |
| ![](/img/visionary-render/windows/gallery/tiles.webp) |  **Tiles**<br/>Show 48 x 48 px previews and icons of assets followed by their name and type. |
...
![](/img/visionary-render/windows/gallery/group.webp)
...
![](/img/visionary-render/windows/gallery/gallery-icon.webp)
