...
![](/img/visionary-render/windows/browser/overview.webp)
...
| View | Description |
| --- | --- |
| ![](/img/visionary-render/windows/browser/large.webp) | ![](/img/visionary-render/windows/browser/large-icon.webp) **Large icons**<br/>Show 96 x 96 px previews and icons of assets followed by their names. |
| ![](/img/visionary-render/windows/browser/small.webp) | ![](/img/visionary-render/windows/browser/small-icon.webp) **Small icons**<br/>Show 48 x 48 px previews and icons of assets followed by their names. |
| ![](/img/visionary-render/windows/browser/list.webp) | ![](/img/visionary-render/windows/browser/list-icon.webp) **List**<br/>Show 16 x 16 px previews and icons of assets followed by their name and properties. Most of the properties can be edited. |
...
![](/img/visionary-render/windows/browser/group.webp)
...
![](/img/visionary-render/windows/browser/create-asset.webp)
