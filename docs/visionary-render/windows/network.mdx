...
![](/img/visionary-render/windows/network/overview.webp)
...
![](/img/visionary-render/windows/network/enable.webp)

Click on the **Enable networking** checkbox to enable networking. 

This enables both outgoing and incoming connections. Other users will be able to connect at any time after networking has been enabled. To disable networking, click on the checkbox again. 
...
![](/img/visionary-render/windows/network/connect1.webp)

![](/img/visionary-render/windows/network/connect2.webp)
...
![](/img/visionary-render/windows/network/active.webp)

This shows a list of the connections to the other members in the current collaboration session.

## Voice Chat

![](/img/visionary-render/windows/network/voice-chat.webp)
...
![](/img/visionary-render/windows/network/settings.webp)
...
![](/img/visionary-render/windows/network/text-chat.webp)
...
![](/img/visionary-render/windows/network/statistics.webp)
