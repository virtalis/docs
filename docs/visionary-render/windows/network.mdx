...
![](/img/visionary-render/windows/network/overview.png)
...
![](/img/visionary-render/windows/network/enable.png)
...
![](/img/visionary-render/windows/network/connect1.png)

![](/img/visionary-render/windows/network/connect2.png)
...
![](/img/visionary-render/windows/network/active.png)

This shows a list of the connections to the other members in the current collaboration session.

## Voice Chat

![](/img/visionary-render/windows/network/voice-chat.png)
...
![](/img/visionary-render/windows/network/settings.png)
...
![](/img/visionary-render/windows/network/text-chat.png)
...
![](/img/visionary-render/windows/network/statistics.png)
