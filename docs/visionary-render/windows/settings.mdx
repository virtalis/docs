...
![](/img/visionary-render/windows/settings/overview.webp)
...
![](/img/visionary-render/windows/settings/search-bar.webp)
...
![](/img/visionary-render/windows/settings/menu.webp)
...
![](/img/visionary-render/windows/settings/save-as.webp)

A tree view will now appear as below. Choose the settings that you wish to save then select **OK**.

![](/img/visionary-render/windows/settings/select.webp)
...
![](/img/visionary-render/windows/settings/settings-panel.webp)
...
| Lock | Shows a ![](/img/visionary-render/windows/settings/lock.webp) icon when a User Setting is locked. |
| User Setting | Shows the value of a User Setting. |
| Scene Override | Shows the value of a Scene Override if present, or a ![](/img/visionary-render/windows/settings/override.webp) icon to add a new override.                                                  |
| Delete | Shows a ![](/img/visionary-render/windows/settings/delete.webp) icon when a Scene Override is present to permit it to be deleted. |

### Scene Overrides

![](/img/visionary-render/windows/settings/scene-overrides.webp)

Scene Overrides can be used to save settings - such as a skybox - with your scene. To add a Scene Override, click on the ![](/img/visionary-render/windows/settings/override.webp) icon in the Scene Override column or right-click on the name of the setting and select **Add Override** from the context menu.

![](/img/visionary-render/windows/settings/add-override.webp)
...
You can choose to ignore any Scene Overrides by locking specific User Settings. To lock a setting, right-click on its name and select **Lock** from the context menu. A ![](/img/visionary-render/windows/settings/lock.webp) icon will appear to the right of the setting name, and the User Setting will gain a **Green** border if there's a Scene Override to indicate that it is now the active setting.

To unlock a setting, right-click on its name and select **Unlock** from the context menu, or click on the ![](/img/visionary-render/windows/settings/lock.webp) icon. Locked settings persist between sessions, so you can permanently ignore Scene Overrides if you wish.
...
![](/img/visionary-render/windows/settings/new-group.webp)
