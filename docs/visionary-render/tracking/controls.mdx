...
![](/img/visionary-render/tracking/controls/xbox.png)
...
![](/img/visionary-render/tracking/controls/touch.png)
...
![](/img/visionary-render/tracking/controls/wmr.png)
...
![](/img/visionary-render/tracking/controls/hololens2.png)
...
![](/img/visionary-render/tracking/controls/menu.png)

You can now press the **Edit** button to change the default bindings, as below.

![](/img/visionary-render/tracking/controls/bindings.png)
