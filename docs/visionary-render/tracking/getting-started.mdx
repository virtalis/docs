...
7. If you need to reconnect at any time you can do so by pressing the Reconnect button on the connection status window. If a loss of connection is detected then Visionary Render will automatically try to reconnect to the HoloLens. ![](/img/visionary-render/tracking/getting-started/dialog.png)

:::tip
See [Augmented Reality](augmented-reality.mdx) for information on using the HoloLens 2.
:::
