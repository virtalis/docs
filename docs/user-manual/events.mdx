...
![](/img/user-manual/chapter34/1.jpg)
...
|-------------------|---------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Activate          | \_\_Other                 | Fired when [<u>vrActivate</u>](http://docsmaster/prog/group__api__lua.html#1ga8e87277025a56b7c7265f65cae9b43de) is called. The caller of [<u>vrActivate</u>](http://docsmaster/prog/group__api__lua.html#1ga8e87277025a56b7c7265f65cae9b43de) can set the value of \_\_Other to whatever is required inside this event. Also triggered by double clicking on some node types in the tree. |
| Break             | \_\_Other                 | Fired when two objects stop touching each other in the scene. \_\_Self is this object, \_\_Other is the object that it touched. The guard condition can be set to an Assembly to only fire Break events for that Assembly instead of any node in the scene. Note: you’ll need to add a Collision node to \_\_Self for this event to be fired.                                             |
...
| Gesture Activated | \_\_Gesture               | Fired when a gesture is made that matches one of the recorded ones.                                                                                                                                                                                                                                                                                                                       |
| Key Press         | \_\_KeyCode, \_\_KeyState | Fired when a key on the keyboard is pressed, or the mouse is clicked, or a tracker button is pressed.                                                                                                                                                                                                                                                                                     |
| Key Release       | \_\_KeyCode, \_\_KeyState | Fired when a key, mouse, or tracker button is released.                                                                                                                                                                                                                                                                                                                                   |
| Leave             |                           | Fired when a subsequent fly-to operation flies somewhere else.                                                                                                                                                                                                                                                                                                                            |
| Move              |                           | Fired when an assembly is moved in the scene.                                                                                                                                                                                                                                                                                                                                             |
| Pose Entered      | \_\_Pose, \_\_PoseState   | Fired when a pose is made.                                                                                                                                                                                                                                                                                                                                                                |
| Pose Left         | \_\_Pose, \_\_PoseState   | Fired when a pose is left.                                                                                                                                                                                                                                                                                                                                                                |
...
| Time Step         | \_\_TimeDelta             | Fired every frame.                                                                                                                                                                                                                                                                                                                                                                        |
| Toggle            |                           | Fired when a 3D GUI item toggle state changes.                                                                                                                                                                                                                                                                                                                                            |
| Touch             | \_\_Other                 | Fired when two objects touch each other in the scene. \_\_Self is this object, \_\_Other is the object that it touched. The guard condition can be set to an Assembly to only fire Touch events for that Assembly instead of any node in the scene. Note: you’ll need to add a Collision node to \_\_Self for this event to be fired.                                                     |
| View Deselect     | \_\_Other                 | Fired when a node is deselected. This otherwise behaves the same as View Select.                                                                                                                                                                                                                                                                                                          |
| View Select       | \_\_Other                 | Fired when a node is selected. \_\_Other contains the view selection node containing the selection. Note that selecting in the Scenes or Developer views will fire this event twice (once for each view, as the selection is synchronized).                                                                                                                                               |
...
| Activate a Snapshot | Play a Sequence |
| --- | --- |
| Fly to a Viewpoint | Change a Material |
| Execute a Lua Script | Toggle the enabled state |
| Play a sound |  |
...
| Action | Description |
| --- | --- |
| Disable | Set to off the Enabled state of the Assembly. |
| Enable | Set to on the Enabled state of the Assembly. |
...
![](/img/user-manual/chapter34/2.jpg)
...
![](/img/user-manual/chapter34/3.jpg)
...
![](/img/user-manual/chapter34/4.jpg)
