...
| ![](/img/user-manual/chapter36/3.jpg) | **Plane** - Generates texture coordinates by projecting a plane onto the mesh. |
| --- | --- |
| ![](/img/user-manual/chapter36/4.jpg) | **Box** - Generates texture coordinates by projecting a cube onto the mesh. |
| ![](/img/user-manual/chapter36/5.jpg) | **Cylinder** - Generates texture coordinates by projecting a cylinder onto the mesh. |
| ![](/img/user-manual/chapter36/6.jpg) | **Sphere** - Generates texture coordinates by projecting a sphere onto the mesh. |
| ![](/img/user-manual/chapter36/7.jpg) | **Linear** - Generates texture coordinates by projecting a line onto the mesh. This can be used to apply gradient textures to geometry. |
