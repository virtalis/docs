...
| Image | Description |
| --- | --- |
| ![](/img/user-manual/chapter18/12.jpg) | **Cascade**<br/>Overlay all the assets in a category from the top-left to bottom-right of the preview panel. |
| ![](/img/user-manual/chapter18/13.jpg) | **Tile**<br/>Organise the assets in a category as tiles. |
| ![](/img/user-manual/chapter18/14.jpg) | **First**<br/>Only show the first asset in a category. |
| ![](/img/user-manual/chapter18/15.jpg) | **Last**<br/>Only show the last asset in a category. |
...
| Image | Description |
| --- | --- |
| ![](/img/user-manual/chapter18/26.jpg) |  **Large icons**<br/>Show 96 x 96 px previews and icons of assets followed by their names. |
| ![](/img/user-manual/chapter18/26.jpg) |  **Small icons**<br/>Show 48 x 48 px previews and icons of assets followed by their names. |
| ![](/img/user-manual/chapter18/26.jpg) |  **Large list**<br/>Show 48 x 48 px previews and icons of assets followed by their name and type. Additional columns show the location and description of an asset. |
| ![](/img/user-manual/chapter18/26.jpg) |  **List**<br/>Show 16 x 16 px previews and icons of assets followed by their name. Additional columns show the type, location, and description of an asset. |
| ![](/img/user-manual/chapter18/26.jpg) |  **Tiles**<br/>Show 48 x 48 px previews and icons of assets followed by their name and type. |
