...
![](/img/user-manual/chapter18/1.jpg)
...
The ![](/img/user-manual/chapter18/2.jpg) buttons at the top-left of the window navigate backwards and forwards through the selection history.
...
![](/img/user-manual/chapter18/3.jpg)
...
![](/img/user-manual/chapter18/4.jpg)
...
![](/img/user-manual/chapter18/5.jpg)
...
![](/img/user-manual/chapter18/6.jpg)
...
![](/img/user-manual/chapter18/7.jpg)
...
![](/img/user-manual/chapter18/8.jpg)
...
![](/img/user-manual/chapter18/9.jpg)

The ![](/img/user-manual/chapter18/10.jpg) ![](/img/user-manual/chapter18/11.jpg) buttons at the sides of the preview navigate to the previous or next item in a directory.
...
| ![](/img/user-manual/chapter18/12.jpg) | **Cascade** - Overlay all the assets in a category from the top-left to bottom-right of the preview panel. |
| --- | --- |
| ![](/img/user-manual/chapter18/13.jpg) | **Tile** - Organise the assets in a category as tiles. |
| ![](/img/user-manual/chapter18/14.jpg) | **First** - Only show the first asset in a category. |
| ![](/img/user-manual/chapter18/15.jpg) | **Last** - Only show the last asset in a category. |

#### Editing Assets

To edit assets in the Browse view, right-click on them to bring up the context menu.

![](/img/user-manual/chapter18/16.jpg)
...
| Gallery Icon        | This submenu can be used to set the icon of an asset (see [18.5 Gallery Icon](#gallery-icon)).                                                                                                                                                                                                                                       |
...
![](/img/user-manual/chapter18/17.jpg)
...
![](/img/user-manual/chapter18/18.jpg)
...
![](/img/user-manual/chapter18/19.jpg)
...
![](/img/user-manual/chapter18/20.jpg)
...
| View       | Allow the assets to be displayed in a variety of different layouts (see [18.4.1 View](#view-2)). |
| Sort by    | Sort the assets by a selection of their properties (see [18.4.2 Sort](#sort-1)).                 |
| Group by   | Group the assets by a selection of their properties (see [18.4.3 Group](#group-1)).              |
...
![](/img/user-manual/chapter18/21.jpg)
...
![](/img/user-manual/chapter18/22.jpg)
...
![](/img/user-manual/chapter18/23.jpg)
...
![](/img/user-manual/chapter18/24.jpg)
...
![](/img/user-manual/chapter18/25.jpg)
...
![](/img/user-manual/chapter18/26.jpg)
...
|  |  Large iconsShow 96 x 96 px previews and icons of assets followed by their names. |
| --- | --- |
|  |  Small iconsShow 48 x 48 px previews and icons of assets followed by their names. |
|  |  Large listShow 48 x 48 px previews and icons of assets followed by their name and type. Additional columns show the location and description of an asset. |
|  |  ListShow 16 x 16 px previews and icons of assets followed by their name. Additional columns show the type, location, and description of an asset. |
|  |  TilesShow 48 x 48 px previews and icons of assets followed by their name and type. |
...
![](/img/user-manual/chapter18/27.jpg)
...
![](/img/user-manual/chapter18/28.jpg)
