...
| Annotations | Audio | Gradients |
| --- | --- | --- |
| Groups | Lights | Materials |
| Material Definitions | Measurements | Models |
| Movies | Particles | Scripts |
| Sequences | Snapshots | Textures |
| Viewpoints |  |  |
...
| ![](/img/user-manual/chapter12/2.jpg) |  **Large icons** - Show 96 x 96 px previews and icons of assets followed by their names. |
| --- | --- |
| ![](/img/user-manual/chapter12/3.jpg) |  **Small icons** - Show 48 x 48 px previews and icons of assets followed by their names. |
| ![](/img/user-manual/chapter12/4.jpg) |  **List** - Show 16 x 16 px previews and icons of assets followed by their name and properties. Most of the properties can be edited. |
