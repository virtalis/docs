...
The Animation Sequencer is a keyframe-based animation editor that permits you to create and edit animations. It is a tabbed window that cosists of media controls, a properties panel, track list, timeline, and track view.
