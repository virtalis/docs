...
![](/img/user-manual/chapter29/1.jpg)
...
![](/img/user-manual/chapter29/2.jpg)
...
![](/img/user-manual/chapter29/3.jpg)

A file dialog will be shown as below.

![](/img/user-manual/chapter29/4.jpg)
...
![](/img/user-manual/chapter29/5.jpg)
...
![](/img/user-manual/chapter29/6.jpg)
...
![](/img/user-manual/chapter29/7.jpg)
...
![](/img/user-manual/chapter29/8.jpg)
...
![](/img/user-manual/chapter29/9.jpg)
...
![](/img/user-manual/chapter29/10.jpg)
...
![](/img/user-manual/chapter29/13.jpg)
...
|----------------------------------------|------------------------------------------------------------------------------|
| ![](/img/user-manual/chapter29/14.jpg) | Original file has red, green, and blue values for each point.                |
| ![](/img/user-manual/chapter29/15.jpg) | Display the point cloud with no colour – disabling the Use Colour Attribute. |
| ![](/img/user-manual/chapter29/16.jpg) | Using a Gradient image to colour the points depending on their altitude.     |
...
![](/img/user-manual/chapter29/17.jpg)
...
![](/img/user-manual/chapter29/18.jpg)
