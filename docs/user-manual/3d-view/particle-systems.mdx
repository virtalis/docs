...
![](/img/user-manual/chapter28/1.jpg) ![](/img/user-manual/chapter28/2.jpg) ![](/img/user-manual/chapter28/3.jpg)
...
![](/img/user-manual/chapter28/4.jpg)
...
![](/img/user-manual/chapter28/5.jpg)
...
![](/img/user-manual/chapter28/6.jpg)
...
![](/img/user-manual/chapter28/7.jpg)
...
| Tiling Mode | Tiling allows you to specify part of a texture to split into a grid. The options are None, Random, Animated and Animated Random. When selected, you can specify the number of rows and columns for the texture tiles. For this to work well, ensure that your texture is evenly space in a grid format.With animated and animated random, you also have an animation speed.An example image would be akin to the Muybridge footage that shows 16 frames of animation of a horse running. With set animation, at 4x4, the animation moves along the top row at the speed specified before dropping a row and continuing. This cycle repeats. |
| Billboard Mode | Selecting between XY or XZ determines the direction the billboard faces. |
| Orient U/V | Orientation is apparent when using random direction for particle systems. When specified, it will align the texture in the direction of emission. In this example, the particles are emitted both up and down. With orient V, the arrows point up and down.Without orientation, the arrows all face the same direction. |
...
| Scale Mode | There are three different scale modes that are only applicable when parented to an object.None, any changes in the parent scale won’t affect the size of the emitter or particle size.Shape, any changes in the parent scale affect the size of the emitter but the particle size remains the same.Full, any changes in the parent scale affect the size of the emitter and the particle size. |
...
| Emit Shape | The shape that particles are randomly created within.When specifying a mesh, the mesh used is not the visual element but the sub geo-group level mesh. |
| Shape Angle | When cone is selected, a slider defining the Angle range of the emit shape is available. |
...
| Force | Adding values to force will apply a directional force to particles over lifetime. This would commonly be used to replicate gravity on a fountain water particle system or similar effect. |

### Emission Module

![](/img/user-manual/chapter28/8.jpg)
...
![](/img/user-manual/chapter28/9.jpg)

## Input Functions

![](/img/user-manual/chapter28/10.jpg)
...
![](/img/user-manual/chapter28/13.jpg)
...
![](/img/user-manual/chapter28/14.jpg)
...
![](/img/user-manual/chapter28/15.jpg) ![](/img/user-manual/chapter28/16.jpg) ![](/img/user-manual/chapter28/17.jpg)
...
![](/img/user-manual/chapter28/18.jpg)
...
![](/img/user-manual/chapter28/19.jpg)
