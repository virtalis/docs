...
They can also be used within the Event handling system and within a Lua Script. This is covered in the Programming Guide (HTML), which can be accessed from the Start Menu in the Visionary Render folder.
