...
| Shape                                 | Description                                                                                                                                                                          |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/user-manual/chapter8/46.jpg) | **Plane**<br/>A plane in the XZ axis (i.e. facing the sky). ~1m x 1m.                                                                                                                      |
| ![](/img/user-manual/chapter8/47.jpg) | **Cube**<br/>An axis-aligned cube. ~1m x 1m x 1m.                                                                                                                                          |
| ![](/img/user-manual/chapter8/48.jpg) | **Sphere**<br/>A sphere composed of 1482 triangles. ~1m in diameter.                                                                                                                       |
| ![](/img/user-manual/chapter8/49.jpg) | **Cubic Sphere**<br/>A sphere with a flat surface projected onto it. ~1m in diameter.                                                                                                      |
| ![](/img/user-manual/chapter8/50.jpg) | **Disc**<br/>A disc in the XZ axis (i.e. facing the sky). ~1m in diameter.                                                                                                                 |
| ![](/img/user-manual/chapter8/51.jpg) | **Cone**<br/>A cone with its tip pointing to the sky. ~1m x 1m x 1m.                                                                                                                       |
| ![](/img/user-manual/chapter8/52.jpg) | **Cylinder**<br/>A cylinder with its faces pointing to the sky and ground. ~1m x 1m x 1m.                                                                                                  |
| ![](/img/user-manual/chapter8/53.jpg) | **Torus**<br/>A surface of revolution generated by revolving a circle in three-dimensional space about an axis coplanar to it (or, more intuitively, a “doughnut” shape). ~1m x 0.3m x 1m. |
| ![](/img/user-manual/chapter8/54.jpg) | **Torus Knot**<br/>A special kind of knot that lies on the surface of an unknotted torus in three-dimensional space. ~1.6m x 1.2m x 1.7m.                                                  |
| ![](/img/user-manual/chapter8/55.jpg) | **Arrow**<br/>A composite shape made up of a cuboid and pyramid. It points along the negative Z axis by default. ~0.25m x 0.25m x 1m.                                                      |
| ![](/img/user-manual/chapter8/56.jpg) | **Room**<br/>A room composed of 6 individual plane assemblies. ~1m x 1m x 1m.                                                                                                              |
| ![](/img/user-manual/chapter8/57.jpg) | **Axis**<br/>A 4-part assembly that can be used to visually represent a coordinate system. ~0.23m x 0.23m x 0.23m.                                                                         |
