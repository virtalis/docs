...
![](/img/user-manual/chapter8/1.jpg)
...
![](/img/user-manual/chapter8/2.jpg)
...
| ![](/img/user-manual/chapter8/3.jpg) | ![](/img/user-manual/chapter8/4.jpg) |
|-------------------------|-------------------------|
...
| ![](/img/user-manual/chapter8/5.jpg)                                                                                                         | ![](/img/user-manual/chapter8/6.jpg)                                                                                               |
|---------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| **Encapsulate** - Drag from left-to-right to select encapsulated objects (i.e. any object with all its pixels in the selection box). | **Intersect** - Drag from right-to-left to select intersected objects (i.e. any object with a pixel in the selection box). |
...
| Action                   | Description                                                                                                                                                                                                                                                                                       |
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/user-manual/chapter8/7.jpg)  | Hold down Middle button and move the mouse forward or backward to move in to or out from the current view, or left and right to swivel the view.                                                                                                                                                  |
| ![](/img/user-manual/chapter8/8.jpg)  | Hold down Middle + Right button and move the mouse to pan the view up or down, left or right.                                                                                                                                                                                                     |
| ![](/img/user-manual/chapter8/9.jpg)  | Hold down Shift + Middle button and move the mouse forward or backward to tilt the view, or left and right to swivel.                                                                                                                                                                             |
| ![](/img/user-manual/chapter8/10.jpg) | Hold down Ctrl + Middle button and move the mouse to orbit selected Assemblies left or right, up or down.                                                                                                                                                                                         |
| ![](/img/user-manual/chapter8/11.jpg) | Scroll the Mouse wheel to zoom in to or out from the cursor. Hold down Ctrl to increase the zoom speed or Shift to change the field of view instead (if the viewport supports this). Zooming can be enabled or disabled from the Settings window under `User Interface` > `Mouse` > `Scroll Wheel Zoom`. |

#### Keyboard

| Action        | Keys                                                          | Action     | Keys                                                          |
|---------------|---------------------------------------------------------------|------------|---------------------------------------------------------------|
| Move Forward  | ![](/img/user-manual/chapter8/12.jpg)                                | Turn Left  | ![](/img/user-manual/chapter8/13.jpg)                                |
| Move Backward | ![](/img/user-manual/chapter8/14.jpg)                                | Turn Right | ![](/img/user-manual/chapter8/15.jpg)                                |
| Move Up       | ![](/img/user-manual/chapter8/16.jpg)                                | Move Left  | ![](/img/user-manual/chapter8/17.jpg) ![](/img/user-manual/chapter8/18.jpg) |
| Move Down     | ![](/img/user-manual/chapter8/19.jpg)                                | Move Right | ![](/img/user-manual/chapter8/20.jpg) ![](/img/user-manual/chapter8/21.jpg) |
| Look Up       | ![](/img/user-manual/chapter8/22.jpg) ![](/img/user-manual/chapter8/23.jpg) | Look Down  | ![](/img/user-manual/chapter8/24.jpg) ![](/img/user-manual/chapter8/25.jpg) |
...
| Action                   | Response                                        |
|--------------------------|-------------------------------------------------|
| ![](/img/user-manual/chapter8/24.jpg) | Move the view forward or backward in the scene. |
| ![](/img/user-manual/chapter8/25.jpg) | Pan the view left or right in the scene.        |
| ![](/img/user-manual/chapter8/26.jpg) | Pan the view up or down in the scene.           |
| ![](/img/user-manual/chapter8/27.jpg) | Tilt the view to look up or down.               |
| ![](/img/user-manual/chapter8/28.jpg) | Swivel the view to look left or right.          |
| ![](/img/user-manual/chapter8/29.jpg) | Unassigned.                                     |
...
![](/img/user-manual/chapter8/30.jpg)
...
![](/img/user-manual/chapter8/31.jpg)
...
| ![](/img/user-manual/chapter8/32.jpg) | ![](/img/user-manual/chapter8/33.jpg) |
|--------------------------|--------------------------|
| Before                   | After                    |
...
| ![](/img/user-manual/chapter8/34.jpg) | ![](/img/user-manual/chapter8/35.jpg) |
|--------------------------|--------------------------|
| Before                   | After                    |

## Viewpoints

Visionary Render can save and recall present view positions in the scene. They can be used to display key aspects of the scene being displayed. Viewpoints are a type of Assembly used to store an interesting or important view in the scene. They are identified in the Scenes tree by the ![](/img/user-manual/chapter8/36.jpg) icon.
...
![](/img/user-manual/chapter8/39.jpg)
...
![](/img/user-manual/chapter8/40.jpg)
...
![](/img/user-manual/chapter8/41.jpg)
...
![](/img/user-manual/chapter8/42.jpg)
...
![](/img/user-manual/chapter8/43.jpg)
...
![](/img/user-manual/chapter8/44.jpg)
...
|                                |                                                                                                                                                                                      |
|--------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/user-manual/chapter8/46.jpg) | Plane - A plane in the XZ axis (i.e. facing the sky). ~1m x 1m.                                                                                                                      |
| ![](/img/user-manual/chapter8/47.jpg) | Cube - An axis-aligned cube. ~1m x 1m x 1m.                                                                                                                                          |
| ![](/img/user-manual/chapter8/48.jpg) | Sphere - A sphere composed of 1482 triangles. ~1m in diameter.                                                                                                                       |
| ![](/img/user-manual/chapter8/49.jpg) | Cubic Sphere - A sphere with a flat surface projected onto it. ~1m in diameter.                                                                                                      |
| ![](/img/user-manual/chapter8/50.jpg) | Disc - A disc in the XZ axis (i.e. facing the sky). ~1m in diameter.                                                                                                                 |
| ![](/img/user-manual/chapter8/51.jpg) | Cone - A cone with its tip pointing to the sky. ~1m x 1m x 1m.                                                                                                                       |
| ![](/img/user-manual/chapter8/52.jpg) | Cylinder - A cylinder with its faces pointing to the sky and ground. ~1m x 1m x 1m.                                                                                                  |
| ![](/img/user-manual/chapter8/53.jpg) | Torus - A surface of revolution generated by revolving a circle in three-dimensional space about an axis coplanar to it (or, more intuitively, a “doughnut” shape). ~1m x 0.3m x 1m. |
| ![](/img/user-manual/chapter8/54.jpg) | Torus Knot - A special kind of knot that lies on the surface of an unknotted torus in three-dimensional space. ~1.6m x 1.2m x 1.7m.                                                  |
| ![](/img/user-manual/chapter8/55.jpg) | Arrow - A composite shape made up of a cuboid and pyramid. It points along the negative Z axis by default. ~0.25m x 0.25m x 1m.                                                      |
| ![](/img/user-manual/chapter8/56.jpg) | Room - A room composed of 6 individual plane assemblies. ~1m x 1m x 1m.                                                                                                              |
| ![](/img/user-manual/chapter8/57.jpg) | Axis - A 4-part assembly that can be used to visually represent a coordinate system. ~0.23m x 0.23m x 0.23m.                                                                         |

### Super-Quadrics

There's also a sub-menu with options for creating various super-quadrics (i.e. 3D parametric objects).

![](/img/user-manual/chapter8/58.jpg)
...
| ![](/img/user-manual/chapter8/59.jpg) | ![](/img/user-manual/chapter8/60.jpg) |
|--------------------------|--------------------------|
...
Visionary Render supports stereo 3D. It can be enabled from the ![](/img/user-manual/chapter8/61.jpg) button in the Toolbar or by pressing **F10**. Stereo is achieved by rendering the 3D view twice, once into each eye, at different camera angles.

### Settings

Stereo can be configured for the Settings window under `Renderer` > `General`.

![](/img/user-manual/chapter8/62.jpg)
...
![](/img/user-manual/chapter8/63.jpg) ![](/img/user-manual/chapter8/64.jpg)
...
![](/img/user-manual/chapter8/65.jpg)
