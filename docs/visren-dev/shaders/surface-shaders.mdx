...
![](/img/visren-dev/surface-shader-click-drag-apply.png)
...
![](/img/visren-dev/surface-shader-instance-applied.png)

#### 2. Right-Click on a Material and select "Create -> Surface Shader Instance". 

![](/img/visren-dev/surface-shader-create.png)
...
![](/img/visren-dev/surface-shader-param-inherit.png)
...
![](/img/visren-dev/surface-shader-param-types.png)
