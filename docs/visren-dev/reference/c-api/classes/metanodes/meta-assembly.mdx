...
| Type           | Name           |
| -------------- | -------------- |
| enum| **[CONSTRAINT_TYPE](#enum-constraint-type)** \{ CONSTRAINT_NONE, CONSTRAINT_LOCK, CONSTRAINT_PARENT, CONSTRAINT_LIMIT, CONSTRAINT_IK, CONSTRAINT_LOOKAT \}<br />Values for Idx_Constraint.  |
...
| Idx_Constraint | | [CONSTRAINT_TYPE](#enum-constraint-type) (int) - Type of constraint to be enforced on this assemblies transform.   |
