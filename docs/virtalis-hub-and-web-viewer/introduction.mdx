---
sidebar_position: 1
slug: /virtalis-hub-and-web-viewer
---
...
| ![](/img/virtalis-hub-and-web-viewer/assets.webp) | ![](/img/virtalis-hub-and-web-viewer/viewer.webp) |
|--------------|------------|
...
:::note
This manual is aimed at a general audience and requires no prior knowledge. To learn about setting up and configuring the platform, see the [Virtalis Hub System Admin Guide](../virtalis-hub-system-admin).
:::
