...
:::note
This manual will teach you how to access the platform, navigate its features, and start working on your engineering projects. If you are a system admin and wish to know about setting up and configuring the platform at your organisation, see the [Virtalis Hub System Admin Guide](../virtalis-hub-system-admin/introduction.mdx).
:::
