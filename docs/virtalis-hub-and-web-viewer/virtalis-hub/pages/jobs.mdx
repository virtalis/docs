...
This page shows data that has been, or is currently being, processed by Virtalis Hub.
...
Click **Cancel** to cancel an in-progress job on the Job Status page. Virtalis Hub will attempt to cancel the job by halting the current process and then cleaning up any data that had already been written.
