...
This page displays a list of all the assets available for use in your projects. You can search for and update existing assets or upload a new asset to the library. It also displays the version number of each asset.
...
:::tip
The **Import an Asset** button is available from any page of Virtalis Hub and Web Viewer.
:::
