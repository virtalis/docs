---
sidebar_position: 2
description: 2019.2 to 2024.2
---

# GeoVisionary

:::note
See the [Visionary Render Changelog](visren.mdx) for further changes that affect GeoVisionary.
:::
...
- Start menu shortcut for the Visionary Render Developer Guide
...
- Stall at startup when using a licence without the "Immersive" feature
