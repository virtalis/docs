...
- Adds an improved API for node observer in Lua. Updates the function signatures of `vrAddNodeObserver` and `vrAddMetaNodeObserver`. The old versions have been deprecated. See [Observers](../visren-prog/scripts/metanodes/observers.mdx) for more information
...
- Adds the [VR Exchange API](../visren-prog/reference/c-api/modules/vrexchange.mdx)
...
![](/img/visren-prog/diagnostics-window.png)
