...
- Textures can be compressed or rescaled to reduce load times and overall scene size

#### Changed

- Web browser textures can be quickly setup with a 1920×1080 default size and predictable resizing
...
- Cannot use the grip buttons for navigation in OpenXR mode
