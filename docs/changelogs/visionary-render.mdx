...
- New manikin control mode to allow control of manikins of different sizes (anthropometrics) using joint rotations instead of IK target positions
...
- Support for Virtalis Reach/Hub
...
- Include GUI option on Screen Capture Tool breaks GUI clipping
