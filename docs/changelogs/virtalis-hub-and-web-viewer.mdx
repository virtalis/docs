---
sidebar_position: 4
description: 2020.3 to 2025.1
---

# Virtalis Hub and Web Viewer
...
- Metadata display to the product tree
- Grab, Move, and Reset laser modes that can be selected via icons above your controller. Choose between laser off, standard laser, short laser (for grabbing and moving objects with precision), and reset laser (instantly return manipulated objects to their original positions)
- Revision history button to the Scenes page to permit you to review old versions of your projects
- Rules-based controls for key features like the product tree and metadata display to permit them to be customised
- Textures applied in Visionary Render now appear correctly in the Web Viewer
- Basic animations created in Visionary Render now work in the Web Viewer
- New movement speed controls that give you more precise navigation control
- Support for fullscreen mode on double-click

#### Changed

- Perform object culling on the client-side to improve performance and the stability of collaborations
- Made several improvements to how complex data is managed and processed to allow the server to host more complex scenes with greater efficiency
- Updated the frontend to permit you to focus on your content, including a cleaner, collapsible collaboration panel and product tree
...
- Picking support to the product tree and 3D scene
- A window to display all active collaborators in the scene
- Support for custom background colours if set in Visionary Render scenes
- 'Create project' option during asset import to streamline the process of creating and publishing a new project from an asset
- Ability to disable 3D scene picking for specific projects in Visionary Render using the rules system
- Ability to select, show/hide and centre the view on items in the product tree
- Scene title display once a scene has loaded
- Notifications to highlight events such as users entering or leaving a collaboration
- Support for Pico devices

#### Changed

- Improved keyboard controls by reducing the likelihood of accidently triggering developer shortcuts
...
- Scenes can be uploaded to and downloaded from Virtalis Hub directly to Visionary Render
...
- Button to the navbar to access the new beta web viewer
...
- Existing web viewer and its functionality as it wasn't scalable
