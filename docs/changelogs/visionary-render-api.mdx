...
- `relTo` parameter from [vrScriptEditorSetInsertPos](../visionary-render-programming/reference/lua-api/modules/script-editor.mdx#vrscripteditorsetinsertpos) and [vrScriptEditorSetMarkPos](../visionary-render-programming/reference/lua-api/modules/script-editor.mdx#vrscripteditorsetmarkpos)
