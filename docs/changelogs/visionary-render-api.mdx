...
- [vrControlManikinJoints](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrcontrolmanikinjoints) - Take control of a manikin's joints with a specified user (or local user if none specified)
- [vrExplodeMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrexplodemesh) - Divide a mesh into individual nodes based on which parts of the mesh are connected
- [vrGenerateNormals](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrgeneratenormals) - Calculate the normal vectors of a mesh based on the mesh geometry and a smoothing threshold
- [vrGenerateTangents](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrgeneratetangents) - Calculate the tangent vector for each vertex on a mesh
- [vrGenerateUVs](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrgenerateuvs) - Calculate the texture coordinate for each vertex on a mesh based on a mapping mode and axis
- [vrInvertMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrinvertmesh) - Invert the surfaces of a mesh by reversing the winding of the polygons
- [vrMergeMeshes](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrmergemeshes) - Merge all the children of a selected Assembly into a single Model node
- [vrOptimiseMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vroptimisemesh) - Perform various common optimisations to your models
- [vrPruneMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrprunemesh) - Remove a proportion of the physically separate parts of a mesh at random, e.g. for reducing density of foliage in a tree model
- [vrRecentreMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrrecentremesh) - Recentre a mesh based on its bounding box
- [vrSieveMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrsievemesh) - Remove physically separate parts of a mesh that are smaller than a specified size
- [vrSortVertices](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrsortvertices) - Perform an optimisation on indexed triangle lists within a mesh to reduce the number of cache misses that occur when looking for vertices on the graphics card
- [vrTessellateMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrtessellatemesh) - Perform a re-tessellation on the selected mesh
- [vrTransformMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrtransformmesh) - Transform the vertices of a mesh
- [vrWeldMesh](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrweldmesh) - Merge vertices of a mesh that are within a specified distance of each other

#### Changed

- Display literal values of default arguments instead of constant names in function prototypes, such as `127` instead of `VR_CHAR_MAX`

#### Deprecated

- [vrGeometryOp](../visionary-render-programming/reference/lua-api/modules/geometry-operators#vrgeometryop) - Use the new individual geometry operator functions instead
...
- [vrControlManikinTargets](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrcontrolmanikintargets) - Take control of a manikin with a specified user (or local user if none specified)
- [vrReleaseManikin](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrreleasemanikin) - Releases a manikin from the user who is controlling it

#### Fixed

- Crash when there are more than 64 levels of transformed assemblies
- Pivots are not created at the origin when requested
...
- Missing Lua observer callbacks to [vrAddNodeObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddnodeobserver) and [vrAddMetaNodeObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddmetanodeobserver) to support better node event tracking and bring the Lua API in line with the C API
- [vrNodeGetUUID](../visionary-render-programming/reference/lua-api/modules/nodes.mdx#vrnodegetuuid) to get the UUID of a node
- [vrCompressTexture](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrcompresstexture) to apply DXT compression to a texture
- [vrCanCompressTexture](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrcancompresstexture) to determine whether DXT compression can be applied to a texture
- [vrScaleTexture](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrscaletexture) to scale a texture by a specified factor
- [vrCanScaleTexture](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrcanscaletexture) to determine whether a texture can be scaled
...
- [vrBakeMesh](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrbakemesh) to convert deformable meshes to static meshes for export and upload
- [vrGetDirectoryContents](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrgetdirectorycontents) to return the files and folders in a directory as a table of tables
- Missing documentation for various optional parameters

#### Fixed

- [vrShowGUIFrame](../visionary-render-programming/reference/lua-api/modules/gui.mdx#vrshowguiframe) ignores its `show` parameter and can't be used to hide the GUI
...
- [vrSetting](../visionary-render-programming/reference/lua-api/modules/settings.mdx) functions will continue to work when the setting they reference is moved
- [vrSettingWrite](../visionary-render-programming/reference/lua-api/modules/settings.mdx#vrsettingwrite) throws a warning instead of an error when attempting to write to a setting that no longer exists

#### Fixed

- Make [vrExtractBinaryAssets](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrextractbinaryassets) accept unversioned metanode names and deduce the metanode type automatically from the provided node if no explicit type is defined
...
- [vrHasLicenceFeature](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrhaslicencefeature) to check whether a licence feature is available
...
- [vrDisableNetwork](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrdisablenetwork) to permit networking to be disabled, in contrast to [vrEnableNetwork](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrenablenetwork)

#### Removed

- `relTo` parameter from [vrScriptEditorSetInsertPos](../visionary-render-programming/reference/lua-api/modules/scripts.mdx#vrscripteditorsetinsertpos) and [vrScriptEditorSetMarkPos](../visionary-render-programming/reference/lua-api/modules/scripts.mdx#vrscripteditorsetmarkpos)

#### Fixed

- Prevent [vrSettingCreate](../visionary-render-programming/reference/lua-api/modules/settings.mdx) functions from being able to create unnamed settings
...
- [vrSplitVirtalisHubURL](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrsplitvirtalishuburl) to identify Virtalis Hub URLs and extract their server name, artifact ID and artifact name

#### Fixed

- [vrDot](../visionary-render-programming/reference/lua-api/modules/maths.mdx#vrdot) to work with [vrvec4](../visionary-render-programming/reference/lua-api/classes/vrvec4) values
...
- [vrGenerateQRCodeFile](../visionary-render-programming/reference/lua-api/modules/core.mdx#vrgenerateqrcodefile) to permit QR codes to be generated and saved to a file (which is used by the HoloLens 2 to view scenes in Augmented Reality)
...
- Incorrect return values from [vrNodeIsInGroup](../visionary-render-programming/reference/lua-api/modules/nodes.mdx#vrnodeisingroup)
...
- [vrNodeFindChild](../visionary-render-programming/reference/lua-api/modules/nodes.mdx#vrnodefindchild) to return `nil` instead of the node to search from when passed an empty search path
...
- [vrAddPropertyObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddpropertyobserver) can observe multiple properties of a metanode
...
- 40 functions to the Lua API for creating your own metanode types:
...
- Adds an improved API for node observer in Lua. Updates the function signatures of [vrAddNodeObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddnodeobserver) and [vrAddMetaNodeObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddmetanodeobserver). The old versions have been deprecated.
...
![](/img/visionary-render-programming/diagnostics-window.webp)
...
[vrAddNodeObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddnodeobserver) and [vrAddMetaNodeObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddmetanodeobserver) have been extended to support additional callbacks.
...
- Lua functions registered with [vrAddNodeObserver](../visionary-render-programming/reference/lua-api/modules/observers.mdx#vraddnodeobserver) and similar, now have valid `__Script` and `__Self` registers when called
