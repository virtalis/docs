...
- Update HOOPS Exchange to 2026.4.0
- Update dAPI to 23.0 (Creo 13.0)
- Update ODA to 27.4

#### Fixed

- Division importer applies wrong materials to objects in older VDI scenes
- Division importer fails to load VTX textures
...
- Update HOOPS Exchange to 2026.1.1

#### Fixed

- Transparent objects are not being rendered correctly in the COLLADA importer
- Design and Drawing importer recipe filenames are incorrect
...
- Support for 3ds Max 2026 to Max Exporter 1.11

#### Changed

- Update HOOPS Exchange to 2025.7
- Update ODA to 2026.6
- Update Assimp to 6.0.2

#### Removed

- Support for 3ds Max 2018 from Max Exporter 1.11

#### Fixed

- Crash in the COLLADA importer
...
- VRML importer setting **Assembly Read Setup** > **Import sets as assemblies** to expand sets and build them as individual assemblies, which permits VRML files to maintain their original tree structure

#### Changed

- Update HOOPS Exchange to 2025.4
- Update dAPI to 21.1 (Creo 11.1)

#### Fixed

- Materials in Creo View files are not always imported correctly when part of a full PVZ file
...
- Update HOOPS Exchange to 2025.2

#### Removed

- Changelogs and manuals (these have been moved to Virtalis Docs)

#### Fixed

- PDF3D importer does not import any geometry
- Normals are wrongly transformed in HOOPS-based importers
- Revit importer fails when the "Read Wireframes" setting is enabled
