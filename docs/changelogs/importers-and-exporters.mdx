...
- Support for 3ds Max 2025 to Max Exporter
...
- Support for 3ds Max 2017 from Max Exporter
...
- Support for 3ds Max 2024 to Max Exporter
...
- Support for 3ds Max 2014, 2015 and 2016 from Max Exporter
...
- Support for 3ds Max 2023 to Max Exporter
...
- Support for 3ds Max 2021 and 2022 to Max Exporter

#### Changed

- Updates the Revit importer to use HOOPS so that it is more up-to-date and reliable
- Improve window layouts in Max Exporter on high-resolution displays
...
- Support for subdivisions and sides options on splines to Max Exporter
- Support for Spline Select and Linked XForm modifiers to Max Exporter
- Warning to Max Exporter when skin vertices are affected by more than 4 bones
...
- Set exported splines in Max Exporter to tube mode when they have non-zero thickness
...
- Support for 3ds Max 2020 to Max Exporter
- Ability to export visibility tracks as sequence property tracks in Max Exporter
- Spline IK control modifier to animate splines in Max Exporter
- Tooltips to the Max Exporter settings
...
- Improve GUI layout and update Virtalis logo in Max Exporter
...
- Version number mismatch and broken revision number in Max Exporter
...
- Wrong translation in Look At constraints in Max Exporter
- Missing DLL error in Max Exporter when 3ds Max is initialised
