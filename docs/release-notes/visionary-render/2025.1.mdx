...
Thank you for downloading Visionary Render 2025.1. In this release we have focused on improving stability, boosting performance in dynamic scenes, and extending support for large-scale immersive environments. Whether you are doing design reviews, collaboration sessions or editing complex scenes, these changes are designed to make your workflow smoother and more efficient. 

## What's New in This Release

### Introducing Virtalis Docs - Comprehensive Documentation Portal 

We're pleased to announce our new HTML documentation portal, Virtalis Docs. This resource is accessible both locally and online at https://docs.virtalis.com/ 

- **All-in-One Resource:** Access all software manuals, guides and changelogs in a single location (local and online).
- **Multiple Access Points:** Easily access help by pressing `F1` or clicking `?` icons throughout the application. Launch from the start menu, app menu, importers, or when using specific tools.
- **Enhanced Content:** The manuals and guides have been extended and re-organised to make related topics easier to find.
- **Searchable:** The online version of the docs is searchable for easy access.
...
- **Efficient Rendering:** Scenes now only re-render when something changes, reducing unnecessary GPU use and making the interface feel snappier when editing large scenes. This new feature is toggle-able (Renderer/Performance) under the "Stop Rendering when static" setting.
...
You can now easily restore some or all settings to a particular configuration through the settings GUI. This is especially useful if you’d like to swap between tailored setups for Visionary Render or to restore to a known configuration.
...
- **Command-Line Options:** Restore settings via command line with `-restoresettings` to restore to a selected settings file on application startup.
...
We continue to focus on addressing issues you've reported and improving the quality of Visionary Render. In this release, we identified and resolved 18 issues, 6 of which were reported by customers. 

| ID | Summary |
|---|---|
| FUS-3290 | More reliable importing of revit files when "Read Wireframes" is enabled. |
...
:::note
See the [Changelog](../../changelogs/visionary-render#20251) for a complete list of resolved issues and changes.
:::

## Removed Features

- Standalone changelogs and start menu links for the Visionary Render manual and programming guide (these have been moved to Virtalis Docs).

We are committed to continuous improvement - your feedback drives our progress. Enjoy the improved performance and new features in Visionary Render 2025.1, and thank you for your continued support.
