...
Users are now able to generate 1:1 scale manikins in a scene. These manikins can be easily posed through the use of Inverse and Forward Kinematics. Manikin bones can be individually scaled in order to match anthropometric data. 
