...
Thank you for downloading GeoVisionary 2025.2. This release focuses on deepening immersion for XR workflows, streamlining everyday configuration tasks, and strengthening the fidelity of exported data for downstream processes.
...
```mdx-code-block
<LiteYouTubeEmbed id="qjrmjErPItY" params="autoplay=1&autohide=1&showinfo=0&rel=0" title="GeoVisionary - Immersive Web Browser" poster="maxresdefault" webp />
```
...
```mdx-code-block
<LiteYouTubeEmbed id="ipXiuoGGeCs" params="autoplay=1&autohide=1&showinfo=0&rel=0" title="GeoVisionary - Experimental Hand Tracking" poster="maxresdefault" webp />
```
...
```mdx-code-block
<LiteYouTubeEmbed id="en3bQI4oTd8" params="autoplay=1&autohide=1&showinfo=0&rel=0" title="GeoVisionary - Settings Search" poster="maxresdefault" webp />
```
...
```mdx-code-block
<LiteYouTubeEmbed id="q0kqcl-i5g4" params="autoplay=1&autohide=1&showinfo=0&rel=0" title="GeoVisionary - Vertex Snapping" poster="maxresdefault" webp />
```
...
![](/img/release-notes/visionary-render/2025.2-1.webp)
...
![](/img/release-notes/visionary-render/2025.2-2.webp)
...
We continue to focus on addressing issues you report and improving the quality of GeoVisionary. In this release we identified and resolved 65 issues, 21 of which were reported as bugs and 7 were raised directly by customers. 
...
| FUS-3731 | Solid selection highlighting no longer invokes transparency in GeoVisionary 2025.1 |

:::note
See the [Changelog](../../changelogs/geovisionary#20252) for a complete list of resolved issues and changes.
:::
