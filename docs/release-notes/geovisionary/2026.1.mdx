...
Thank you for downloading GeoVisionary 2026.1. This release delivers visible improvements to rendering, immersive tracking, and interaction. You will see cleaner visuals in large scenes, simpler plug-and-play tracking in OpenXR mode, and more predictable VR interaction.
